# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_potoky.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_potoky.F"
...
# 4 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_potoky.F" 2

      Subroutine POTOKy(Nx,Dx,Dt,Qlx,Qrx,Qpm,Qdx,Qdz,Qrp,Fm) 
      Implicit NONE
      Integer nx,i,m,l

      real (kind=8) Qlx(Nx,7),Qrx(Nx,7),Qpm(Nx,7),Qdx(Nx,7),Qdz(Nx,7)
      ...
      real (kind=8) udx(7),udz(7),ax(7,7),az(7,7),av(7)
      real (kind=8) tvl(7),tvr(7),tp(7),tc(7),tdx(7),tdz(7)
      real (kind=8) DT,DX,DTX,DXI,TL6

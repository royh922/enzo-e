# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_sub.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_sub.F"
...
# 4 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_sub.F" 2

      SUBROUTINE VECTLRx(QU,QL,QR,U)
      Implicit NONE

      real (kind=8) QU(7),QL(7,7),QR(7,7),U(7)          
      real (kind=8) DLT,X22,SK1,BVX,BVY,BVZ,VAX,VAY,VAZ
      real (kind=8) VAH,CKV,A1,A2,CSR,CSV,CWH,DSCV,VF2
      real (kind=8) VS2,CF,CS,CA,BXX,BYZ,SBB,BMG,GPP,GPB
      real (kind=8) ASS,AS,AF,BY,BZ,BSGN,CD2
      ...
      real (kind=8) DLT,X22,SK1,BVX,BVY,BVZ,VAX,VAY,VAZ
      real (kind=8) VAH,CKV,A1,A2,CSR,CSV,CWH,DSCV,VF2
      real (kind=8) VS2,CF,CS,CA,BYY,BXZ,SBB,BMG,GPP,GPB
      real (kind=8) ASS,AS,AF,BX,BZ,BSGN,CD2
      ...
      real (kind=8) VAH,CKV,A1,A2,CSR,CSV,CWH,DSCV,VF2
      real (kind=8) VS2,CF,CS,CA,BYY,BXZ,SBB,BMG,GPP,GPB
      real (kind=8) ASS,AS,AF,BX,BY,BSGN,CD2
      ...
      real (kind=8) QU(7),U(7)          
      real (kind=8) DLT,SK1,BVX,BVY,BVZ,VAX,VAY,VAZ
      real (kind=8) VAH,CKV,A1,A2,CSR,CSV,CWH,DSCV,VF2
      real (kind=8) VS2,CF,CS,VA,BXX,BYZ,SBB,BMG,GPP,GPB
      ...
      real (kind=8) DLT,SK1,BVX,BVY,BVZ,VAX,VAY,VAZ
      real (kind=8) VAH,CKV,A1,A2,CSR,CSV,CWH,DSCV,VF2
      real (kind=8) VS2,CF,CS,VA,BYY,BXZ,SBB,BMG,GPP,GPB
      ...
      real (kind=8) QU(7),U(7)          
      real (kind=8) DLT,SK1,BVX,BVY,BVZ,VAX,VAY,VAZ,VA
      real (kind=8) VAH,CKV,A1,A2,CSR,CSV,CWH,DSCV,VF2
      real (kind=8) VS2,CF,CS,BXX,BYZ,SBB,BMG,GPP,GPB
      ...
      real (kind=8) QU(7),F(7)
      real (kind=8) A1,A2,BKV,PXX 
      ...
      Integer m
      real (kind=8) QL(7),QR(7),QP(7),QC(7)
      real (kind=8) DQ,Q6,Y
      ...
      real (kind=8) qul(7),qur(7),qsr(7)
      real (kind=8) RL,RR,RS
      ...
      Implicit NONE
      Integer m,nx,i
      real (kind=8) Qvr(Nx,7),Qvl(Nx,7),Qp(Nx,7) 
      real (kind=8) Qrx(Nx,7),Qlx(Nx,7) 
      real (kind=8) DQ,Q6
      ...
      real (kind=8) x,y,z,Xminmod,Xmedian
      ...
      real (kind=8) IS1,IS2,IS3,DELTA,WS1,WS2,WS3,WJ1,WJ2,WJ3
      real (kind=8) AJ1,AJ2,AJ3,AJS,WM1,WM2,WM3,VL,VR
      real (kind=8) VP1,VP2,VP3,VP4,VP5

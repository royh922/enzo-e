# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_potokz.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_potokz.F"
...
# 4 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_potokz.F" 2

      Subroutine POTOKz(Nx,Dx,Dt,Qlx,Qrx,Qpm,Qdx,Qdy,Qrp,Fm)
      Implicit NONE
      Integer nx,i,m,l     
      real (kind=8) Qlx(Nx,7),Qrx(Nx,7),Qpm(Nx,7),Qdx(Nx,7),Qdy(Nx,7)
      real (kind=8) Qrp(Nx,7),Fm(Nx,7) 
      
      real (kind=8) qp(7),px(7),qc(7),qvl(7),qvr(7)           
      real (kind=8) vm(7),ql(7,7),qr(7,7),uv(7),vl(7)
      real (kind=8) sl(7),qul(7),qur(7),tl(7)
      real (kind=8) tr(7),fr(7),ur(7),qv(7)
      real (kind=8) udx(7),udy(7),ay(7,7),ax(7,7),av(7)
      real (kind=8) tvl(7),tvr(7),tp(7),tc(7),tdx(7),tdy(7)
      real (kind=8) DT,DX,DTX,DXI,TL7

# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_HLLD.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_HLLD.F"
...
# 4 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppml_fortran/PPML_HLLD.F" 2

      Subroutine HLLDx(UL,UR,F,U) !SL and SR from min/max
      Implicit NONE
      
      real (kind=8) U(7),F(7),UL(7),UR(7)

      Integer i
      real (kind=8) Uhll(7),Fhll(7)
      real (kind=8) FL(7),FR(7)
      real (kind=8) SL,SR,SL_rot,SR_rot
      real (kind=8) cf,ca           ! fast and Alfven velocities
      real (kind=8) Bx,By,Bz,BB
      real (kind=8) u_L,v_L,w_L,u_R,v_R,w_R
      real (kind=8) ptL, ptR
      real (kind=8) u_ast
      real (kind=8) UL_ast(7),UR_ast(7)

!temporary
      real (kind=8) f2,f3,X,g3,g4,g5,g6
      real (kind=8) S1L, S1R, S2L, S2R
      real (kind=8) a,a1,a2,ds
...
!temporary
      real (kind=8) f2,f3,X,g2,g4,g5,g7
      real (kind=8) S1L, S1R, S2L, S2R
      real (kind=8) a,a1,a2,ds
...
c        pause
      ...
      End ! Subroutine HLLDy
        ...
        !temporary
        real (kind=8) f2,f3,X,g2,g3,g5,g6
        real (kind=8) S1L, S1R, S2L, S2R
        real (kind=8) a,a1,a2,ds

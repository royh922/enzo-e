# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/flux_hll.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/flux_hll.F"
...
# 3 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/flux_hll.F" 2
c=======================================================================
...
# 60 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/flux_hll.F" 2
c
...
c
     ...
     $     ifallback
      ...
      real(kind=8) dx(idim)
      real(kind=8) uls(idim,jdim), vls(idim,jdim), wls(idim,jdim),
...
c
      ...
      real(kind=8) sqrtdl, sqrtdr, gamma1, isdlpdr, vroe1, vroe2, vroe3, v2,
     $     hroe, tl, tr, dl, dr, q1, dub, delu, energy, qc,
     $     gamma1i, csl0, csr0
      real(kind=8) cs(ijkn), char1(ijkn), char2(ijkn), csl(ijkn), csr(ijkn),
     ...
     $     bm0(ijkn), bp0(ijkn)
      real(kind=8) dfl(ijkn), dfr(ijkn), ufl(ijkn), ufr(ijkn), 
     $     vfl(ijkn), vfr(ijkn), wfl(ijkn), wfr(ijkn),
     $     efl(ijkn), efr(ijkn), gefl(ijkn), gefr(ijkn),
     $     gesl(ijkn), gesr(ijkn),
     $     colfl(ijkn,20), colfr(ijkn,20)
      real(kind=8) sl(ijkn), sr(ijkn), sm(ijkn)
      real(kind=8) dubl, dubr
...
c
         cs(i) = sqrt(gamma1*max((hroe - 0.5_RKIND*v2), 1.d-20))
         char1(i) = vroe1 - cs(i)
         char2(i) = vroe1 + cs(i)
      enddo
c
...
c
# 295 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/flux_hll.F"
c

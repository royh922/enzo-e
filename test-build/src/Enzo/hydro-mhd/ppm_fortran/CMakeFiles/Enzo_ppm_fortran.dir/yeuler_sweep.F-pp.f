# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/yeuler_sweep.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/yeuler_sweep.F"
...
# 4 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/yeuler_sweep.F" 2
...
# 121 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/yeuler_sweep.F" 2
c     
c-----------------------------------------------------------------------
c
...
c
     ...
     &     ncolor, coloff(ncolor)
      ...
      real (kind=8) d(in,jn,kn), e(in,jn,kn), u(in,jn,kn), v(in,jn,kn), 
...
c
      real (kind=8) dls(jn,kn),    drs(jn,kn),flatten(jn,kn),
     ...
     &     gef(jn,kn),   gels(jn,kn),   gers(jn,kn)
      real (kind=8) ges(jn,kn)
      real (kind=8) dslice(jn,kn), eslice(jn,kn),grslice(jn,kn),
     &      uslice(jn,kn), vslice(jn,kn), wslice(jn,kn),
     &     geslice(jn,kn)
      real (kind=8) colslice(jn,kn,ncolor),  colf(jn,kn,ncolor),

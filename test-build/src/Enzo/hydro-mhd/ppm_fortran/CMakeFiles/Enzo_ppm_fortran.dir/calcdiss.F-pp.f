# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/calcdiss.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/calcdiss.F"
...
# 2 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/calcdiss.F" 2
...
# 117 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/calcdiss.F" 2
c
      integer (kind=4) ijkn
...
c
      integer (kind=4) dimx, dimy, dimz, i1, i2, idiff, idim, idir, iflatten, 
     &        j1, j2, jdim, k, kdim, nzz
      real(kind=8)    gamma, dt, dx(idim), dy(jdim), dz(kdim)
      real(kind=8)    dslice(idim,jdim), eslice(idim,jdim), uslice(idim,jdim),
     &        diffcoef(idim,jdim), flatten(idim,jdim), pslice(idim,jdim)
      real(kind=8)    v(dimx,dimy,dimz), w(dimx,dimy,dimz)
c
c  locals
c
      integer (kind=4) i, j, nyz, is, isp, ism
      real(kind=8)    cj2s, di(ijkn), difftemp(ijkn), flattemp(ijkn),
     ...
     &        wdiff2(ijkn), wflag(ijkn), Z, ZE
      logical (kind=4) ljx1,ljy1,ljz1,ljx2,ljy2,ljz2,lj1,lj2
      logical (kind=4) lkx1,lky1,lkz1,lkx2,lky2,lkz2,lk1,lk2
      real(kind=8) dp1,dp2,de1,de2,dee,dpp,omega_tilde
c
c  parameters
c
      real(kind=8)    epsilon, kappa1, kappa2, Kparam, nu1, nu2, nu3,
...
c              CW84 (A.9). !AK
c
               ZE   = s*Z/dslice(ism,j) + uslice(ism,j) + 1.d-20
...
c     
c-----------------------------------------------------------------------
c (C)  Compute complex(kind=16) diffusion coefficient
c     

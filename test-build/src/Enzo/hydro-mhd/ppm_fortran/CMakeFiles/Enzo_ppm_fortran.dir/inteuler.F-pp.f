# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/inteuler.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/inteuler.F"
...
# 3 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/inteuler.F" 2
c=======================================================================
...
# 75 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/inteuler.F" 2
c
      integer (kind=4) ijkn
...
c
      integer (kind=4) gravity, i1, i2, idim, idual, iflatten, ipresfree, 
     &        isteep, j1, j2, jdim, ncolor, iconsrec, iposrec
      real(kind=8)  dt, eta1, eta2, gamma
      real(kind=8)  dslice(idim,jdim),     dxi(idim     ),  pslice(idim,jdim),
     &        uslice(idim,jdim),  vslice(idim,jdim),  wslice(idim,jdim),
     &        grslice(idim,jdim), geslice(idim,jdim)
      real(kind=8)  dls(idim,jdim),     drs(idim,jdim), flatten(idim,jdim),
     &        pls(idim,jdim),
     ...
     &        vrs(idim,jdim),     wls(idim,jdim),     wrs(idim,jdim)
      real(kind=8)  colslice(idim,jdim,ncolor),   colls(idim,jdim,ncolor),
     &     colrs(idim,jdim,ncolor)
      integer (kind=4) ierror
c
c  local declarations
c
      integer (kind=4) i, j, n, m, ic
      real(kind=8) steepen(ijkn),tmp1(ijkn),tmp2(ijkn),tmp3(ijkn),tmp4(ijkn)
      real(kind=8) qa,qb,qc,qd,qe,s1,s2,f1
      real(kind=8)  c1(ijkn), c2(ijkn), c3(ijkn), c4(ijkn), c5(ijkn), c6(ijkn)
     &    ,c7(ijkn), c8(ijkn)
     ...
     &    ,colla(ijkn,20),colra(ijkn,20)
     &    ,coll0(ijkn,20),colr0(ijkn,20)
     &    ,dcol(ijkn,20),coll(ijkn,20)
     &    ,colr(ijkn,20),col6(ijkn,20)
      real(kind=8) lem(idim,5,5),rem(idim,5,5), dxdt2(ijkn)
c
c  parameters
c
      real(kind=8) ft
...
c
     ...
     &           /((dxb(i) + dxb(i-1))*
     &           (dslice(i+1,j) - dslice(i-1,j) + 1.d-20))
...
c
     ...
     &            colr0(1,ic))
      enddo
c
# 301 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/inteuler.F"
c
c
...
c     correction above).
c
# 490 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/inteuler.F"
c
...
c
# 541 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/inteuler.F"
c
c     Enforce minimum values.
c
      do i=i1, i2+1
         pls(i,j) = max(pls(i,j), 1.d-20)
         prs(i,j) = max(prs(i,j), 1.d-20)
         dls(i,j) = max(dls(i,j), 1.d-20)
         drs(i,j) = max(drs(i,j), 1.d-20)
      enddo
      do ic = 1,ncolor
         do i = i1,i2+1

# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/tscint1d.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/tscint1d.F"
...
# 4 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/tscint1d.F" 2
...
# 43 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/tscint1d.F" 2
c
...
c
     ...
     &                real(6*refine1**3                     )
         coef0(i+1) = 1.d0/refine1 - coefm(i+1) - coefp(i+1)
      enddo
c
...
c
     ...
     &               factor
c     &               parent((i-1)/refine1+1)/(sum + 1.d-20)
...
c
     ...
     &              grid(i-start1+gstart1+refine1-1)
         if (abs(del2right) .lt. 1.d-20) del2right = 
     &        sign(1.d-20, del2right)

# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F"
...
# 3 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F" 2
c=======================================================================
...
# 58 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F" 2
c
c  argument declarations
c
      integer (kind=4) idim, i1, i2, iflatten, isteep, iposrec
      real(kind=8) gamma
      real(kind=8) c1(idim), c2(idim), c3(idim), c4(idim), c5(idim), c6(idim),
     &     char1(idim), char2(idim), c0(idim)
      real(kind=8) dslice(idim), uslice(idim), vslice(idim), wslice(idim),
     $     pslice(idim)
      real(kind=8) dla(idim), dra(idim), dl0(idim), dr0(idim),
     ...
     $     pla(idim), pra(idim), pl0(idim), pr0(idim)
      real(kind=8) dd(idim), dl(idim), dr(idim), d6(idim),
     ...
     $     dp(idim), pl(idim), pr(idim), p6(idim)
      real(kind=8) steepen(idim), flatten(idim)
      real(kind=8) lem(idim,5,5), rem(idim,5,5), dxdt2(idim)
c
c  local declarations (arrays passed as temps)
c
      integer (kind=4) i, m, n
      real(kind=8) temp1, temp2, dxdt, gamma1, pc, rhoc, du2, dplim, 
     $       limit, one
      real(kind=8) qplus(idim,5), qmnus(idim,5), qcent(idim,5), qvanl(idim,5),
...
c
      call lr_states
     $     (dslice, c3, c4, c5, c6, dd, i1, i2, idim, dl, dr)
      call lr_states
     $    (uslice, c3, c4, c5, c6, du, i1, i2, idim, ul, ur)
      call lr_states
     $    (vslice, c3, c4, c5, c6, dv, i1, i2, idim, vl, vr)
      call lr_states
     $    (wslice, c3, c4, c5, c6, dw, i1, i2, idim, wl, wr)
      call lr_states
     $    (pslice, c3, c4, c5, c6, dp, i1, i2, idim, pl, pr)
c
...
c
      call mono_n_flat
     $    (dslice, dl, dr, iflatten, flatten, i1, i2, idim)
      call mono_n_flat
     $    (uslice, ul, ur, iflatten, flatten, i1, i2, idim)
      call mono_n_flat
     $    (vslice, vl, vr, iflatten, flatten, i1, i2, idim)
      call mono_n_flat
     $    (wslice, wl, wr, iflatten, flatten, i1, i2, idim)
      call mono_n_flat
     $    (pslice, pl, pr, iflatten, flatten, i1, i2, idim)
c
c    Now construct left and right interface values (eqn 1.12 and 3.3)
c
      call lr_interface
     $    (dslice, dl, dr, char1, char2, c0, i1, i2, idim,
     $     dd, d6, dla, dra, dl0, dr0)
      call lr_interface
     $    (uslice, ul, ur, char1, char2, c0, i1, i2, idim,
     $     du, u6, ula, ura, ul0, ur0)
      call lr_interface
     $    (vslice, vl, vr, char1, char2, c0, i1, i2, idim,
     $     dv, v6, vla, vra, vl0, vr0)
      call lr_interface
     $    (wslice, wl, wr, char1, char2, c0, i1, i2, idim,
     $     dw, w6, wla, wra, wl0, wr0)
      call lr_interface
     $    (pslice, pl, pr, char1, char2, c0, i1, i2, idim,
...
c-----------------------------------------------------------------------
      ...
      subroutine linslope
     $    (qslice, c1, c2, i1, i2, idim, qplus, qmnus, 
     $     qcent, qvanl)
c      
      implicit none
...
# 260 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F" 2
c
      integer (kind=4) i1, i2, idim
      real(kind=8) qslice(idim), qplus(idim), qmnus(idim), qcent(idim), 
...
# 286 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F" 2
c
      integer (kind=4) n, i1, i2, idim
      real(kind=8) dqc(idim,5), dq(idim), rem(idim,5,5)
...
# 308 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F" 2
c
      integer (kind=4) i1, i2, idim
      real(kind=8) qslice(idim), c3(idim), c4(idim), c5(idim), c6(idim)
      real(kind=8) dq(idim), ql(idim), qr(idim)
...
# 330 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F" 2
c
      integer (kind=4) i1, i2, idim, iflatten
      real(kind=8) qslice(idim), ql(idim), qr(idim), flatten(idim)

      integer (kind=4) i
      real(kind=8) temp1, temp2, temp3, temp22, temp23
c
...
# 386 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intprim.F" 2
c
      integer (kind=4) i1, i2, idim
      real(kind=8) qslice(idim), ql(idim), qr(idim), char1(idim), char2(idim),

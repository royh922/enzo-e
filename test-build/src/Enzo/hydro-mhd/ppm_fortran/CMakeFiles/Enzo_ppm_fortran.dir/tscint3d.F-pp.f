# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/tscint3d.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/tscint3d.F"
...
# 4 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/tscint3d.F" 2
...
# 50 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/tscint3d.F" 2
c
      integer ijkn, MAX_REFINE, num_iter
      parameter (ijkn = (1024+6), num_iter = 2)
...
c
     ...
     &       del1left, del2left, del1next,
     &       del1right, del2right, dV,
...
c
     ...
     &                 grid((i-1)*refine1+gstart1  , jgrid, kgrid)
c
            if (abs(del2left) .lt. 1.d-20) 
     &           del2left = sign(1.d-20, del2left)
...
c
     ...
     &                  grid( i   *refine1+gstart1-1, jgrid, kgrid)
c
            if (abs(del2right) .lt. 1.d-20) 
     &           del2right = sign(1.d-20, del2right)

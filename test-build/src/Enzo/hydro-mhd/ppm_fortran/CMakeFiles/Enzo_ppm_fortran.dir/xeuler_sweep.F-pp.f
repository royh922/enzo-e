# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/xeuler_sweep.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/xeuler_sweep.F"
...
# 4 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/xeuler_sweep.F" 2
...
# 131 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/xeuler_sweep.F" 2
c
c-----------------------------------------------------------------------
c
...
c
      real (kind=8) dls(in,jn),    drs(in,jn),flatten(in,jn),
     ...
     &     gef(in,jn),   gels(in,jn),   gers(in,jn)
      real (kind=8) ges(in,jn)
      real (kind=8) dslice(in,jn), eslice(in,jn), grslice(in,jn),
     &     uslice(in,jn), vslice(in,jn),  wslice(in,jn), 
     &    geslice(in,jn)
      real (kind=8) colslice(in,jn,ncolor),  colf(in,jn,ncolor),

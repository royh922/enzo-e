# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/twoshock.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/twoshock.F"
...
# 3 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/twoshock.F" 2
c=======================================================================
...
# 64 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/twoshock.F" 2
c
      integer (kind=4) ijkn
...
c
      integer (kind=4) gravity, i1, i2, idim, idual, ipresfree, j1, j2, jdim
      real(kind=8)    dt, eta1, gamma, pmin
      real(kind=8)    dls(idim,jdim),     drs(idim,jdim),    pbar(idim,jdim),
...
c
      ...
      real(kind=8)     cl(ijkn),    cr(ijkn), dpdul(ijkn), dpdur(ijkn),
     &         ps(ijkn),    ubl(ijkn),   ubr(ijkn),
     &         qa      ,     zl(ijkn),    zr(ijkn)

      integer (kind=4) itok, jjj
      integer (kind=4) mask(ijkn), jfail(ijkn)
      real(kind=8)    old_ps(ijkn), delta_ps(ijkn)
      real(kind=8)    fails(ijkn)
...
c
# 272 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/twoshock.F"
c
       endif
c
      enddo

# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intvar.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intvar.F"
...
# 3 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intvar.F" 2
c=======================================================================
c///////////////////////  SUBROUTINE INTVAR  \\\\\\\\\\\\\\\\\\\\\\\\\\c

      subroutine intvar(qslice, idim, i1, i2, isteep, steepen,
...
# 52 "/Users/juitenghsu/enzo-e/src/Enzo/hydro-mhd/ppm_fortran/intvar.F" 2
c
c  argument declarations
c
      integer (kind=4) idim, i1, i2, iflatten, isteep
     ...
     &     qla(idim), qra(idim), ql0(idim), qr0(idim)
      real(kind=8) qslice(idim), steepen(idim), flatten(idim)
c
c  parameters
c
      real(kind=8) ft, one
...
c
      integer (kind=4) i
      real(kind=8) qplus, qmnus, qcent, qvanl
      real(kind=8) temp1, temp2, temp3, temp22, temp23
      real(kind=8) dq(idim), ql(idim), qr(idim), q6(idim)
      dq(:) = 0._RKIND
      ql(:) = 0._RKIND
      qr(:) = 0._RKIND
      q6(:) = 0._RKIND

...
/* ---------------- method closures -------------- */
    ...
    struct Closure_Block::p_initial_begin_6_closure : public SDAG::Closure {
      

      p_initial_begin_6_closure() {
        init();
      }
      p_initial_begin_6_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_initial_begin_6_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_initial_begin_6_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_output_enter_9_closure : public SDAG::Closure {
      

      p_output_enter_9_closure() {
        init();
      }
      p_output_enter_9_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_output_enter_9_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_output_enter_9_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_output_end_11_closure : public SDAG::Closure {
      

      p_output_end_11_closure() {
        init();
      }
      p_output_end_11_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_output_end_11_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_output_end_11_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_output_exit_12_closure : public SDAG::Closure {
      

      p_output_exit_12_closure() {
        init();
      }
      p_output_exit_12_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_output_exit_12_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_output_exit_12_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_output_write_14_closure : public SDAG::Closure {
            int index_output;
            int step;


      p_output_write_14_closure() {
        init();
      }
      p_output_write_14_closure(CkMigrateMessage*) {
        init();
      }
      ...
      virtual ~p_output_write_14_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_output_write_14_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_compute_enter_15_closure : public SDAG::Closure {
      

      p_compute_enter_15_closure() {
        init();
      }
      p_compute_enter_15_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_compute_enter_15_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_compute_enter_15_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_compute_continue_16_closure : public SDAG::Closure {
      

      p_compute_continue_16_closure() {
        init();
      }
      p_compute_continue_16_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_compute_continue_16_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_compute_continue_16_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_compute_exit_18_closure : public SDAG::Closure {
      

      p_compute_exit_18_closure() {
        init();
      }
      p_compute_exit_18_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_compute_exit_18_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_compute_exit_18_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_method_flux_correct_refresh_20_closure : public SDAG::Closure {
      

      p_method_flux_correct_refresh_20_closure() {
        init();
      }
      p_method_flux_correct_refresh_20_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_flux_correct_refresh_20_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_flux_correct_refresh_20_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_method_order_morton_weight_24_closure : public SDAG::Closure {
            int *ic3;
            int weight;
            Index index;
      ...
      p_method_order_morton_weight_24_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_method_order_morton_weight_24_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|index;
      ...
      virtual ~p_method_order_morton_weight_24_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_method_order_morton_weight_24_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_method_order_morton_index_25_closure : public SDAG::Closure {
            int index;
            int count;


      p_method_order_morton_index_25_closure() {
        init();
      }
      p_method_order_morton_index_25_closure(CkMigrateMessage*) {
        init();
      }
      ...
      virtual ~p_method_order_morton_index_25_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_order_morton_index_25_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_method_order_hilbert_weight_28_closure : public SDAG::Closure {
            int *ic3;
            int weight;
            Index index;
      ...
      p_method_order_hilbert_weight_28_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_method_order_hilbert_weight_28_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|index;
      ...
      virtual ~p_method_order_hilbert_weight_28_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_method_order_hilbert_weight_28_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_method_order_hilbert_index_29_closure : public SDAG::Closure {
            int index;
            int count;


      p_method_order_hilbert_index_29_closure() {
        init();
      }
      p_method_order_hilbert_index_29_closure(CkMigrateMessage*) {
        init();
      }
            int & getP0() { return index;}
            int & getP1() { return count;}
      ...
      virtual ~p_method_order_hilbert_index_29_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_order_hilbert_index_29_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_stopping_enter_36_closure : public SDAG::Closure {
      

      p_stopping_enter_36_closure() {
        init();
      }
      p_stopping_enter_36_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_stopping_enter_36_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_stopping_enter_36_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_stopping_load_balance_38_closure : public SDAG::Closure {
      

      p_stopping_load_balance_38_closure() {
        init();
      }
      p_stopping_load_balance_38_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_stopping_load_balance_38_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_stopping_load_balance_38_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_stopping_exit_40_closure : public SDAG::Closure {
      

      p_stopping_exit_40_closure() {
        init();
      }
      p_stopping_exit_40_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_stopping_exit_40_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_stopping_exit_40_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_exit_42_closure : public SDAG::Closure {
      

      p_exit_42_closure() {
        init();
      }
      p_exit_42_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_exit_42_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_exit_42_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_control_sync_count_44_closure : public SDAG::Closure {
            int entry_point;
            int id;
            int count;


      p_control_sync_count_44_closure() {
        init();
      }
      p_control_sync_count_44_closure(CkMigrateMessage*) {
        init();
      }
      ...
      virtual ~p_control_sync_count_44_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_control_sync_count_44_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_adapt_enter_45_closure : public SDAG::Closure {
      

      p_adapt_enter_45_closure() {
        init();
      }
      p_adapt_enter_45_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_adapt_enter_45_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_adapt_enter_45_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_adapt_end_47_closure : public SDAG::Closure {
      

      p_adapt_end_47_closure() {
        init();
      }
      p_adapt_end_47_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_adapt_end_47_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_adapt_end_47_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_adapt_update_48_closure : public SDAG::Closure {
      

      p_adapt_update_48_closure() {
        init();
      }
      p_adapt_update_48_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_adapt_update_48_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_adapt_update_48_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_adapt_called_50_closure : public SDAG::Closure {
      

      p_adapt_called_50_closure() {
        init();
      }
      p_adapt_called_50_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_adapt_called_50_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_adapt_called_50_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_adapt_exit_51_closure : public SDAG::Closure {
      

      p_adapt_exit_51_closure() {
        init();
      }
      p_adapt_exit_51_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_adapt_exit_51_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_adapt_exit_51_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_Block::p_adapt_delete_52_closure : public SDAG::Closure {
      

      p_adapt_delete_52_closure() {
        init();
      }
      p_adapt_delete_52_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_adapt_delete_52_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_adapt_delete_52_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_Block::p_refresh_child_57_closure : public SDAG::Closure {
            int n;
            char *a;
            int *ic3;
      ...
      p_refresh_child_57_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_refresh_child_57_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|impl_cnt_ic3;
      ...
      virtual ~p_refresh_child_57_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_refresh_child_57_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: readonly int MsgState::counter[CONFIG_NODE_SIZE];
 */
#ifndef CK_TEMPLATES_ONLY
extern "C" void __xlater_roPup_MsgState_QColon__QColon_counter(void *_impl_pup_er) {
  PUP::er &_impl_p=*(PUP::er *)_impl_pup_er;
#if !CMK_ONESIDED_RO_DISABLE && CMK_ONESIDED_IMPL
  if((CONFIG_NODE_SIZE) * sizeof(int) >= CMK_ONESIDED_RO_THRESHOLD) {
    if(_impl_p.isSizing()) {
    ...
    if(CkNumNodes() == 1)
      regMode = CK_BUFFER_UNREG;
    CkNcpyBuffer myBuffer(& MsgState::counter[0], ((CONFIG_NODE_SIZE) * sizeof(int)), regMode);
      _impl_p|myBuffer;
      if(CkNumNodes() > 1)
        readonlyCreateOnSource(myBuffer);
      PUP::toMem &_impl_p_toMem = *(PUP::toMem *)_impl_pup_er;
...
#endif
  {
  _impl_p(&MsgState::counter[0], ((CONFIG_NODE_SIZE)) );
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
  PUPable_def(MethodOrderHilbert)
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: message MsgState;
 */
#ifndef CK_TEMPLATES_ONLY
void *CMessage_MsgState::operator new(size_t s){
  return MsgState::alloc(__idx, s, 0, 0, GroupDepNum{});
}
void *CMessage_MsgState::operator new(size_t s, int* sz){
  return MsgState::alloc(__idx, s, sz, 0, GroupDepNum{});
}
void *CMessage_MsgState::operator new(size_t s, int* sz,const int pb){
  return MsgState::alloc(__idx, s, sz, pb, GroupDepNum{});
}
void *CMessage_MsgState::operator new(size_t s, int* sz,const int pb, const GroupDepNum groupDepNum){
  return MsgState::alloc(__idx, s, sz, pb, groupDepNum);
}
void *CMessage_MsgState::operator new(size_t s, const int p) {
  return MsgState::alloc(__idx, s, 0, p, GroupDepNum{});
}
void *CMessage_MsgState::operator new(size_t s, const int p, const GroupDepNum groupDepNum) {
  return MsgState::alloc(__idx, s, 0, p, groupDepNum);
}
void* CMessage_MsgState::alloc(int msgnum, size_t sz, int *sizes, int pb, GroupDepNum groupDepNum) {
  CkpvAccess(_offsets)[0] = ALIGN_DEFAULT(sz);
  return CkAllocMsg(msgnum, CkpvAccess(_offsets)[0], pb, groupDepNum);
}
CMessage_MsgState::CMessage_MsgState() {
MsgState *newmsg = (MsgState *)this;
}
void CMessage_MsgState::dealloc(void *p) {
  CkFreeMsg(p);
}
void* CMessage_MsgState::pack(MsgState *msg) {
  return (void *) msg;
}
MsgState* CMessage_MsgState::unpack(void* buf) {
  MsgState *msg = (MsgState *) buf;
  return msg;
}
int CMessage_MsgState::__idx=0;
#endif /* CK_TEMPLATES_ONLY */
...
void r_method_order_hilbert_continue(CkReductionMsg* impl_msg);
void r_method_order_hilbert_complete(CkReductionMsg* impl_msg);
void p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index);
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_initial_begin();
 */
void CProxyElement_Block::p_initial_begin(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_p_initial_begin_void(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_Block::p_output_write(int index_output, int step, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_p_output_write_marshall14(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_Block::p_method_order_morton_weight(const int *ic3, int weight, const Index &index, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_p_method_order_morton_weight_marshall24(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_Block::p_method_order_morton_index(int index, int count, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_p_method_order_morton_index_marshall25(),0);
}
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void r_method_order_hilbert_continue(CkReductionMsg* impl_msg);
 */
void CProxyElement_Block::r_method_order_hilbert_continue(CkReductionMsg* impl_msg) 
{
  ckCheck();
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_r_method_order_hilbert_continue_CkReductionMsg(),0);
}
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void r_method_order_hilbert_complete(CkReductionMsg* impl_msg);
 */
void CProxyElement_Block::r_method_order_hilbert_complete(CkReductionMsg* impl_msg) 
{
  ckCheck();
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_r_method_order_hilbert_complete_CkReductionMsg(),0);
}
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index);
 */
void CProxyElement_Block::p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const int *ic3, int weight, const Index &index
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_p_method_order_hilbert_weight_marshall28(),0);
}
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_method_order_hilbert_index(int index, int count);
 */
void CProxyElement_Block::p_method_order_hilbert_index(int index, int count, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: int index, int count
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_p_method_order_hilbert_index_marshall29(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_Block::p_control_sync_count(int entry_point, int id, int count, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_p_control_sync_count_marshall44(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_Block::p_refresh_child(int n, const char *a, const int *ic3, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_Block::idx_p_refresh_child_marshall57(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_initial_begin();
 */
void CProxy_Block::p_initial_begin(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_p_initial_begin_void(),0);
}

// Entry point registration function
int CkIndex_Block::reg_p_initial_begin_void() {
  int epidx = CkRegisterEp("p_initial_begin()",
      reinterpret_cast<CkCallFnPtr>(_call_p_initial_begin_void), 0, __idx, 0);
  return epidx;
}

void CkIndex_Block::_call_p_initial_begin_void(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  impl_obj->p_initial_begin();
  if(UsrToEnv(impl_msg)->isVarSysMsg() == 0)
    CkFreeSysMsg(impl_msg);
}
PUPable_def(SINGLE_ARG(Closure_Block::p_initial_begin_6_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_output_enter_9_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_output_end_11_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_output_exit_12_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_Block::p_output_write(int index_output, int step, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_p_output_write_marshall14(),0);
}

// Entry point registration function
int CkIndex_Block::reg_p_output_write_marshall14() {
  int epidx = CkRegisterEp("p_output_write(int index_output, int step)",
      reinterpret_cast<CkCallFnPtr>(_call_p_output_write_marshall14), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_output_write_marshall14);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_output_write_marshall14);

  return epidx;
}

void CkIndex_Block::_call_p_output_write_marshall14(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_Block::_callmarshall_p_output_write_marshall14(char* impl_buf, void* impl_obj_void) {
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int index_output, int step*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_Block::_marshallmessagepup_p_output_write_marshall14(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int index_output, int step*/
...
PUPable_def(SINGLE_ARG(Closure_Block::p_output_write_14_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_compute_enter_15_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_compute_continue_16_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_compute_exit_18_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_method_flux_correct_refresh_20_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_Block::p_method_order_morton_weight(const int *ic3, int weight, const Index &index, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_p_method_order_morton_weight_marshall24(),0);
}

// Entry point registration function
int CkIndex_Block::reg_p_method_order_morton_weight_marshall24() {
  int epidx = CkRegisterEp("p_method_order_morton_weight(const int *ic3, int weight, const Index &index)",
      reinterpret_cast<CkCallFnPtr>(_call_p_method_order_morton_weight_marshall24), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_method_order_morton_weight_marshall24);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_method_order_morton_weight_marshall24);

  return epidx;
}

void CkIndex_Block::_call_p_method_order_morton_weight_marshall24(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_Block::_callmarshall_p_method_order_morton_weight_marshall24(char* impl_buf, void* impl_obj_void) {
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: const int *ic3, int weight, const Index &index*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_Block::_marshallmessagepup_p_method_order_morton_weight_marshall24(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const int *ic3, int weight, const Index &index*/
...
PUPable_def(SINGLE_ARG(Closure_Block::p_method_order_morton_weight_24_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_Block::p_method_order_morton_index(int index, int count, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_p_method_order_morton_index_marshall25(),0);
}

// Entry point registration function
int CkIndex_Block::reg_p_method_order_morton_index_marshall25() {
  int epidx = CkRegisterEp("p_method_order_morton_index(int index, int count)",
      reinterpret_cast<CkCallFnPtr>(_call_p_method_order_morton_index_marshall25), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_method_order_morton_index_marshall25);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_method_order_morton_index_marshall25);

  return epidx;
}

void CkIndex_Block::_call_p_method_order_morton_index_marshall25(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_Block::_callmarshall_p_method_order_morton_index_marshall25(char* impl_buf, void* impl_obj_void) {
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int index, int count*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_Block::_marshallmessagepup_p_method_order_morton_index_marshall25(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int index, int count*/
...
PUPable_def(SINGLE_ARG(Closure_Block::p_method_order_morton_index_25_closure))
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void r_method_order_hilbert_continue(CkReductionMsg* impl_msg);
 */
void CProxy_Block::r_method_order_hilbert_continue(CkReductionMsg* impl_msg) 
{
  ckCheck();
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_r_method_order_hilbert_continue_CkReductionMsg(),0);
}

// Entry point registration function
int CkIndex_Block::reg_r_method_order_hilbert_continue_CkReductionMsg() {
  int epidx = CkRegisterEp("r_method_order_hilbert_continue(CkReductionMsg* impl_msg)",
      reinterpret_cast<CkCallFnPtr>(_call_r_method_order_hilbert_continue_CkReductionMsg), CMessage_CkReductionMsg::__idx, __idx, 0);
  CkRegisterMessagePupFn(epidx, (CkMessagePupFn)CkReductionMsg::ckDebugPup);
  return epidx;
}

void CkIndex_Block::_call_r_method_order_hilbert_continue_CkReductionMsg(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  impl_obj->r_method_order_hilbert_continue((CkReductionMsg*)impl_msg);
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void r_method_order_hilbert_complete(CkReductionMsg* impl_msg);
 */
void CProxy_Block::r_method_order_hilbert_complete(CkReductionMsg* impl_msg) 
{
  ckCheck();
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_r_method_order_hilbert_complete_CkReductionMsg(),0);
}

// Entry point registration function
int CkIndex_Block::reg_r_method_order_hilbert_complete_CkReductionMsg() {
  int epidx = CkRegisterEp("r_method_order_hilbert_complete(CkReductionMsg* impl_msg)",
      reinterpret_cast<CkCallFnPtr>(_call_r_method_order_hilbert_complete_CkReductionMsg), CMessage_CkReductionMsg::__idx, __idx, 0);
  CkRegisterMessagePupFn(epidx, (CkMessagePupFn)CkReductionMsg::ckDebugPup);
  return epidx;
}

void CkIndex_Block::_call_r_method_order_hilbert_complete_CkReductionMsg(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  impl_obj->r_method_order_hilbert_complete((CkReductionMsg*)impl_msg);
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index);
 */
void CProxy_Block::p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const int *ic3, int weight, const Index &index
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_p_method_order_hilbert_weight_marshall28(),0);
}

// Entry point registration function
int CkIndex_Block::reg_p_method_order_hilbert_weight_marshall28() {
  int epidx = CkRegisterEp("p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index)",
      reinterpret_cast<CkCallFnPtr>(_call_p_method_order_hilbert_weight_marshall28), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_method_order_hilbert_weight_marshall28);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_method_order_hilbert_weight_marshall28);

  return epidx;
}

void CkIndex_Block::_call_p_method_order_hilbert_weight_marshall28(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  ...
  /*Unmarshall arrays:*/
  int *ic3=(int *)(impl_buf+impl_off_ic3);
  impl_obj->p_method_order_hilbert_weight(ic3, std::move(weight.t), std::move(index.t));
}
int CkIndex_Block::_callmarshall_p_method_order_hilbert_weight_marshall28(char* impl_buf, void* impl_obj_void) {
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: const int *ic3, int weight, const Index &index*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_Block::_marshallmessagepup_p_method_order_hilbert_weight_marshall28(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const int *ic3, int weight, const Index &index*/
...
PUPable_def(SINGLE_ARG(Closure_Block::p_method_order_hilbert_weight_28_closure))
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_method_order_hilbert_index(int index, int count);
 */
void CProxy_Block::p_method_order_hilbert_index(int index, int count, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: int index, int count
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_p_method_order_hilbert_index_marshall29(),0);
}

// Entry point registration function
int CkIndex_Block::reg_p_method_order_hilbert_index_marshall29() {
  int epidx = CkRegisterEp("p_method_order_hilbert_index(int index, int count)",
      reinterpret_cast<CkCallFnPtr>(_call_p_method_order_hilbert_index_marshall29), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_method_order_hilbert_index_marshall29);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_method_order_hilbert_index_marshall29);

  return epidx;
}

void CkIndex_Block::_call_p_method_order_hilbert_index_marshall29(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  ...
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
  impl_obj->p_method_order_hilbert_index(std::move(index.t), std::move(count.t));
}
int CkIndex_Block::_callmarshall_p_method_order_hilbert_index_marshall29(char* impl_buf, void* impl_obj_void) {
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int index, int count*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_Block::_marshallmessagepup_p_method_order_hilbert_index_marshall29(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int index, int count*/
...
PUPable_def(SINGLE_ARG(Closure_Block::p_method_order_hilbert_index_29_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_stopping_enter_36_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_stopping_load_balance_38_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_stopping_exit_40_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_exit_42_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_Block::p_control_sync_count(int entry_point, int id, int count, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_p_control_sync_count_marshall44(),0);
}

// Entry point registration function
int CkIndex_Block::reg_p_control_sync_count_marshall44() {
  int epidx = CkRegisterEp("p_control_sync_count(int entry_point, int id, int count)",
      reinterpret_cast<CkCallFnPtr>(_call_p_control_sync_count_marshall44), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_control_sync_count_marshall44);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_control_sync_count_marshall44);

  return epidx;
}

void CkIndex_Block::_call_p_control_sync_count_marshall44(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_Block::_callmarshall_p_control_sync_count_marshall44(char* impl_buf, void* impl_obj_void) {
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int entry_point, int id, int count*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_Block::_marshallmessagepup_p_control_sync_count_marshall44(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int entry_point, int id, int count*/
...
PUPable_def(SINGLE_ARG(Closure_Block::p_control_sync_count_44_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_adapt_enter_45_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_adapt_end_47_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_adapt_update_48_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_adapt_called_50_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_adapt_exit_51_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_Block::p_adapt_delete_52_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_Block::p_refresh_child(int n, const char *a, const int *ic3, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_Block::idx_p_refresh_child_marshall57(),0);
}

// Entry point registration function
int CkIndex_Block::reg_p_refresh_child_marshall57() {
  int epidx = CkRegisterEp("p_refresh_child(int n, const char *a, const int *ic3)",
      reinterpret_cast<CkCallFnPtr>(_call_p_refresh_child_marshall57), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_refresh_child_marshall57);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_refresh_child_marshall57);

  return epidx;
}

void CkIndex_Block::_call_p_refresh_child_marshall57(void* impl_msg, void* impl_obj_void)
{
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_Block::_callmarshall_p_refresh_child_marshall57(char* impl_buf, void* impl_obj_void) {
  Block* impl_obj = static_cast<Block*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int n, const char *a, const int *ic3*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_Block::_marshallmessagepup_p_refresh_child_marshall57(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int n, const char *a, const int *ic3*/
...
PUPable_def(SINGLE_ARG(Closure_Block::p_refresh_child_57_closure))
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_initial_begin();
 */
void CProxySection_Block::p_initial_begin(const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
...
/* DEFS: void r_method_order_hilbert_continue(CkReductionMsg* impl_msg);
 */
void CProxySection_Block::r_method_order_hilbert_continue(CkReductionMsg* impl_msg) 
{
  ckCheck();
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
...
/* DEFS: void r_method_order_hilbert_complete(CkReductionMsg* impl_msg);
 */
void CProxySection_Block::r_method_order_hilbert_complete(CkReductionMsg* impl_msg) 
{
  ckCheck();
  UsrToEnv(impl_msg)->setMsgtype(ForArrayEltMsg);
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
...
/* DEFS: void p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index);
 */
void CProxySection_Block::p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const int *ic3, int weight, const Index &index
  int impl_off=0;
...
/* DEFS: void p_method_order_hilbert_index(int index, int count);
 */
void CProxySection_Block::p_method_order_hilbert_index(int index, int count, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: int index, int count
  int impl_off=0;
...
void CkIndex_Block::__register(const char *s, size_t size) {
  ...
  // REG: void p_initial_begin();
  idx_p_initial_begin_void();
  ...
  idx_p_method_order_morton_weight_marshall24();

  // REG: void p_method_order_morton_index(int index, int count);
  idx_p_method_order_morton_index_marshall25();

  // REG: void r_method_order_hilbert_continue(CkReductionMsg* impl_msg);
  idx_r_method_order_hilbert_continue_CkReductionMsg();

  // REG: void r_method_order_hilbert_complete(CkReductionMsg* impl_msg);
  idx_r_method_order_hilbert_complete_CkReductionMsg();

  // REG: void p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index);
  idx_p_method_order_hilbert_weight_marshall28();

  // REG: void p_method_order_hilbert_index(int index, int count);
  idx_p_method_order_hilbert_index_marshall29();
  ...
  idx_p_control_sync_count_marshall44();
  ...
  idx_p_refresh_child_marshall57();
...
void _registermesh(void)
{
  ...
  CkRegisterReadonly("MsgState::counter","int",sizeof(MsgState::counter),(void *) &MsgState::counter,__xlater_roPup_MsgState_QColon__QColon_counter);
  ...
  CkRegisterReadonly("g_parameters","Parameters",sizeof(g_parameters),(void *) &g_parameters,__xlater_roPup_g_parameters);
      ...
      PUPable_reg(MethodOrderHilbert);
...
/* REG: message MsgState;
*/
CMessage_MsgState::__register("MsgState", sizeof(MsgState),(CkPackFnPtr) MsgState::pack,(CkUnpackFnPtr) MsgState::unpack);

...
class CkIndex_Simulation:public CkIndex_IrrGroup{
  public:
    ...
    inline static int idx_p_refine_create_block(void (Simulation::*)(MsgRefine* impl_msg) ) {
    ...
    /* DECLS: void p_initial_block_created();
     */
    // Entry point registration at startup
    
    static int reg_p_initial_block_created_void();
    // Entry point index lookup
    
    inline static int idx_p_initial_block_created_void() {
      static int epidx = reg_p_initial_block_created_void();
      return epidx;
    }

    
    inline static int idx_p_initial_block_created(void (Simulation::*)() ) {
      return idx_p_initial_block_created_void();
    }


    
    static int p_initial_block_created() { return idx_p_initial_block_created_void(); }
    
    static void _call_p_initial_block_created_void(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_initial_block_created_void(void* impl_msg, void* impl_obj);
    /* DECLS: void p_initialize_state(MsgState* impl_msg);
     */
    // Entry point registration at startup
    
    static int reg_p_initialize_state_MsgState();
    // Entry point index lookup
    
    inline static int idx_p_initialize_state_MsgState() {
      static int epidx = reg_p_initialize_state_MsgState();
      return epidx;
    }

    
    inline static int idx_p_initialize_state(void (Simulation::*)(MsgState* impl_msg) ) {
      return idx_p_initialize_state_MsgState();
    }


    
    static int p_initialize_state(MsgState* impl_msg) { return idx_p_initialize_state_MsgState(); }
    
    static void _call_p_initialize_state_MsgState(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_initialize_state_MsgState(void* impl_msg, void* impl_obj);
 ...
 */
    ...
    void p_initial_block_created(const CkEntryOptions *impl_e_opts=NULL);
 ...
 */
    ...
    void p_initial_block_created(int npes, int *pes, const CkEntryOptions *impl_e_opts=NULL);
    
    void p_initial_block_created(CmiGroup &grp, const CkEntryOptions *impl_e_opts=NULL);
 ...
 */
    ...
    void p_initialize_state(MsgState* impl_msg, int npes, int *pes);
    
    void p_initialize_state(MsgState* impl_msg, CmiGroup &grp);
...
class CkIndex_MappingArray:public CkIndex_CkArrayMap{
  public:
    ...
    static int __idx;
    static void __register(const char *s, size_t size);
    /* DECLS: MappingArray(int impl_noname_0, int impl_noname_1, int impl_noname_2);
     */
    // Entry point registration at startup
    ...
    static int ckNew(int impl_noname_0, int impl_noname_1, int impl_noname_2) { return idx_MappingArray_marshall1(); }
 ...
 */
    ...
    static CkGroupID ckNew(int impl_noname_0, int impl_noname_1, int impl_noname_2, const CkEntryOptions *impl_e_opts=NULL);
    CProxy_MappingArray(int impl_noname_0, int impl_noname_1, int impl_noname_2, const CkEntryOptions *impl_e_opts=NULL);
...
class CkIndex_MappingTree:public CkIndex_CkArrayMap{
  public:
    ...
    static int __idx;
    static void __register(const char *s, size_t size);
    /* DECLS: MappingTree(int impl_noname_3, int impl_noname_4, int impl_noname_5);
     */
    // Entry point registration at startup
    ...
    static int ckNew(int impl_noname_3, int impl_noname_4, int impl_noname_5) { return idx_MappingTree_marshall1(); }
 ...
 */
    ...
    static CkGroupID ckNew(int impl_noname_3, int impl_noname_4, int impl_noname_5, const CkEntryOptions *impl_e_opts=NULL);
    CProxy_MappingTree(int impl_noname_3, int impl_noname_4, int impl_noname_5, const CkEntryOptions *impl_e_opts=NULL);
...
class CkIndex_MappingIo:public CkIndex_CkArrayMap{
  public:
    ...
    static int __idx;
    static void __register(const char *s, size_t size);
    /* DECLS: MappingIo(int impl_noname_6);
     */
    // Entry point registration at startup
    ...
    static int ckNew(int impl_noname_6) { return idx_MappingIo_marshall1(); }
 ...
 */
    ...
    static CkGroupID ckNew(int impl_noname_6, const CkEntryOptions *impl_e_opts=NULL);
    CProxy_MappingIo(int impl_noname_6, const CkEntryOptions *impl_e_opts=NULL);
...
class Closure_Simulation {
  public:
    ...
    struct p_initial_block_created_15_closure;

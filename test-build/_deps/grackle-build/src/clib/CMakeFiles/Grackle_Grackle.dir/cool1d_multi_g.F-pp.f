# 1 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/cool1d_multi_g.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/cool1d_multi_g.F"
...
# 2 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/cool1d_multi_g.F" 2
...
# 71 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/cool1d_multi_g.F" 2
...
!  Parameters
      ...
      integer ti_max
      real*8 mh, mu_metal
      parameter (mh = 1.67262171d-24)      !DPC
...
!     --- H2 cooling ---
     ...
     &         *(ciecoa(indixe(i)+1) - ciecoa(indixe(i)))
         ...
         do i = is+1, ie+1
            if ( itmask(i) ) then
# 529 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/cool1d_multi_g.F"
...
c            gphdl1 = gphdl(i)/dom
     ...
     &           h2lte(i)/(1._DKIND + gphdl1/galdl(i)) / (2._DKIND*dom)
         ...
         enddo
# 648 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/cool1d_multi_g.F"

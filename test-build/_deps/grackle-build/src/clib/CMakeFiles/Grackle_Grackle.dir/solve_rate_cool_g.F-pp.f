# 1 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F"
...
# 2 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F" 2
...
# 164 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F" 2
...
# 408 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F"
      do t = 0, dk*dj-1
        k = t/dj      + ks+1
        j = mod(t,dj) + js+1
...
!              Bound from below to prevent numerical errors
	       ...
	       if (abs(dedot(i)) .lt. 1.d-40) 
     &             dedot(i) = min(1.d-20,de(i,j,k))
	       if (abs(HIdot(i)) .lt. 1.d-40)
...
# 695 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F"
            else               ! itmask
               dtit(i) = dt;
            endif
...
!               is calculated with this gamma).
               ...
               energy = max(p2d(i)/(gamma-1._DKIND), 1.d-40)
...
!              table and edot < 0, then shut off the cooling.
     ...
     &              edot(i) .lt. 0._DKIND) 
     &              edot(i) = 1.d-40
	       if (abs(edot(i)) .lt. 1.d-40) edot(i) = 1.d-40
...
# 755 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F"
            endif   ! itmask
            enddo   ! end loop over i
...
# 776 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F"
...
!=======================================================================
      ...
      integer, parameter :: DKIND=8
      integer, parameter :: DIKIND=8
# 913 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F" 2
...
!=======================================================================
      ...
      integer, parameter :: DKIND=8
      integer, parameter :: DIKIND=8
# 1008 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F" 2
...
!     locals
      ...
      if (imetal .eq. 1) then
         do k = ks+1, ke+1
            do j = js+1, je+1
               do i = is+1, ie+1
                  metal(i,j,k) = max(metal(i,j,k), 1.d-20)
...
!=======================================================================
      ...
      integer, parameter :: DKIND=8
      integer, parameter :: DIKIND=8
# 1113 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F" 2
...
# 1705 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F"
...
c Direct collisional dissociation
     ...
     &                          (1._DKIND+(nh/k13dd(i,6))**k13dd(i,7))
                     k13_CID = max(10._DKIND**k13_CID, 1.d-40)
c Dissociative tunnelling
     ...
     &                          (1._DKIND+(nh/k13dd(i,13))**k13dd(i,14))
                     k13_DT  = max(10._DKIND**k13_DT, 1.d-40)
c
...
!=======================================================================
      ...
      integer, parameter :: DKIND=8
      integer, parameter :: DIKIND=8
# 1769 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F" 2
...
!=======================================================================
      ...
      integer, parameter :: DKIND=8
      integer, parameter :: DIKIND=8
# 1987 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F" 2
...
!=======================================================================
      ...
      integer, parameter :: DKIND=8
      integer, parameter :: DIKIND=8
# 2433 "/Users/juitenghsu/enzo-e/test-build/_deps/grackle-src/src/clib/solve_rate_cool_g.F" 2

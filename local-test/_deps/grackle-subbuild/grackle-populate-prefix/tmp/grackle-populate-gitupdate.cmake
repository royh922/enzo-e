...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "fca6db9657f16f8ae1e68afdad4b49f3110f7027"
  WORKING_DIRECTORY "/Users/juitenghsu/enzo-e/local-test/_deps/grackle-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "fca6db9657f16f8ae1e68afdad4b49f3110f7027")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("fca6db9657f16f8ae1e68afdad4b49f3110f7027" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: fca6db9657f16f8ae1e68afdad4b49f3110f7027")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/fca6db9657f16f8ae1e68afdad4b49f3110f7027")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"fca6db9657f16f8ae1e68afdad4b49f3110f7027\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/juitenghsu/enzo-e/local-test/_deps/grackle-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/juitenghsu/enzo-e/local-test/_deps/grackle-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

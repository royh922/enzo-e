...
/* ---------------- method closures -------------- */
    ...
    struct Closure_EnzoSimulation::p_method_balance_check_5_closure : public SDAG::Closure {
      

      p_method_balance_check_5_closure() {
        init();
      }
      p_method_balance_check_5_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_balance_check_5_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_balance_check_5_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_EnzoSimulation::p_check_done_7_closure : public SDAG::Closure {
      

      p_check_done_7_closure() {
        init();
      }
      p_check_done_7_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_check_done_7_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_check_done_7_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_set_io_writer_8_closure : public SDAG::Closure {
            CProxy_IoEnzoWriter proxy;


      p_set_io_writer_8_closure() {
        init();
      }
      p_set_io_writer_8_closure(CkMigrateMessage*) {
        init();
      }
      ...
      virtual ~p_set_io_writer_8_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_set_io_writer_8_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_infer_set_array_count_9_closure : public SDAG::Closure {
            int count;


      p_infer_set_array_count_9_closure() {
        init();
      }
      p_infer_set_array_count_9_closure(CkMigrateMessage*) {
        init();
      }
      ...
      virtual ~p_infer_set_array_count_9_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_infer_set_array_count_9_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_infer_array_created_10_closure : public SDAG::Closure {
      

      p_infer_array_created_10_closure() {
        init();
      }
      p_infer_array_created_10_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_infer_array_created_10_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_infer_array_created_10_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_infer_done_11_closure : public SDAG::Closure {
      

      p_infer_done_11_closure() {
        init();
      }
      p_infer_done_11_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_infer_done_11_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_infer_done_11_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_set_io_reader_12_closure : public SDAG::Closure {
            CProxy_IoEnzoReader proxy;


      p_set_io_reader_12_closure() {
        init();
      }
      p_set_io_reader_12_closure(CkMigrateMessage*) {
        init();
      }
      ...
      virtual ~p_set_io_reader_12_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_set_io_reader_12_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_io_reader_created_13_closure : public SDAG::Closure {
      

      p_io_reader_created_13_closure() {
        init();
      }
      p_io_reader_created_13_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_io_reader_created_13_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_io_reader_created_13_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_restart_next_level_14_closure : public SDAG::Closure {
      

      p_restart_next_level_14_closure() {
        init();
      }
      p_restart_next_level_14_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_restart_next_level_14_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_restart_next_level_14_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_restart_level_created_15_closure : public SDAG::Closure {
      

      p_restart_level_created_15_closure() {
        init();
      }
      p_restart_level_created_15_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_restart_level_created_15_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_restart_level_created_15_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoSimulation::p_set_level_array_16_closure : public SDAG::Closure {
            CProxy_EnzoLevelArray proxy;


      p_set_level_array_16_closure() {
        init();
      }
      p_set_level_array_16_closure(CkMigrateMessage*) {
        init();
      }
      ...
      virtual ~p_set_level_array_16_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_set_level_array_16_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
...
/* ---------------- method closures -------------- */
    ...
    struct Closure_EnzoBlock::p_method_feedback_starss_end_3_closure : public SDAG::Closure {
      

      p_method_feedback_starss_end_3_closure() {
        init();
      }
      p_method_feedback_starss_end_3_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_feedback_starss_end_3_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_feedback_starss_end_3_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_m1_closure_solve_transport_eqn_4_closure : public SDAG::Closure {
      

      p_method_m1_closure_solve_transport_eqn_4_closure() {
        init();
      }
      p_method_m1_closure_solve_transport_eqn_4_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_m1_closure_solve_transport_eqn_4_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_m1_closure_solve_transport_eqn_4_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_EnzoBlock::p_method_balance_migrate_8_closure : public SDAG::Closure {
      

      p_method_balance_migrate_8_closure() {
        init();
      }
      p_method_balance_migrate_8_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_balance_migrate_8_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_balance_migrate_8_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_balance_done_9_closure : public SDAG::Closure {
      

      p_method_balance_done_9_closure() {
        init();
      }
      p_method_balance_done_9_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_balance_done_9_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_balance_done_9_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_gravity_continue_10_closure : public SDAG::Closure {
      

      p_method_gravity_continue_10_closure() {
        init();
      }
      p_method_gravity_continue_10_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_gravity_continue_10_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_gravity_continue_10_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_gravity_end_11_closure : public SDAG::Closure {
      

      p_method_gravity_end_11_closure() {
        init();
      }
      p_method_gravity_end_11_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_gravity_end_11_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_gravity_end_11_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_infer_merge_masks_12_closure : public SDAG::Closure {
            int n;
            char *mask;
            int *ic3;
      ...
      p_method_infer_merge_masks_12_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_method_infer_merge_masks_12_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|impl_cnt_ic3;
      ...
      virtual ~p_method_infer_merge_masks_12_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_method_infer_merge_masks_12_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_infer_count_arrays_13_closure : public SDAG::Closure {
            int count;


      p_method_infer_count_arrays_13_closure() {
        init();
      }
      p_method_infer_count_arrays_13_closure(CkMigrateMessage*) {
        init();
      }
            int & getP0() { return count;}
      void pup(PUP::er& __p) {
      ...
      virtual ~p_method_infer_count_arrays_13_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_infer_count_arrays_13_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_infer_request_data_14_closure : public SDAG::Closure {
            int *il3;
      ...
      p_method_infer_request_data_14_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_method_infer_request_data_14_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|impl_cnt_il3;
      ...
      virtual ~p_method_infer_request_data_14_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_method_infer_request_data_14_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_infer_update_15_closure : public SDAG::Closure {
            int n;
            char *buffer;
            int *il3;
      ...
      p_method_infer_update_15_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_method_infer_update_15_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|impl_cnt_il3;
      ...
      virtual ~p_method_infer_update_15_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_method_infer_update_15_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_infer_exit_16_closure : public SDAG::Closure {
      

      p_method_infer_exit_16_closure() {
        init();
      }
      p_method_infer_exit_16_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_infer_exit_16_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_infer_exit_16_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_check_write_first_17_closure : public SDAG::Closure {
            int num_files;
            std::string ordering;
            std::string name_dir;


      p_check_write_first_17_closure() {
        init();
      }
      p_check_write_first_17_closure(CkMigrateMessage*) {
        init();
      }
      ...
      virtual ~p_check_write_first_17_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_check_write_first_17_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_check_write_next_18_closure : public SDAG::Closure {
            int num_files;
            std::string ordering;


      p_check_write_next_18_closure() {
        init();
      }
      p_check_write_next_18_closure(CkMigrateMessage*) {
        init();
      }
            int & getP0() { return num_files;}
            std::string & getP1() { return ordering;}
      ...
      virtual ~p_check_write_next_18_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_check_write_next_18_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_check_done_19_closure : public SDAG::Closure {
      

      p_check_done_19_closure() {
        init();
      }
      p_check_done_19_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_check_done_19_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_check_done_19_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_restart_refine_20_closure : public SDAG::Closure {
            int *ic3;
            int io_reader;
            int ip;
      ...
      p_restart_refine_20_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_restart_refine_20_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|io_reader;
  PUP::detail::TemporaryObjectHolder<int> ip;
  implP|ip;
          impl_buf+=CK_ALIGN(implP.size(),16);
          ic3 = (int *)(impl_buf+impl_off_ic3);
        }
      }
      virtual ~p_restart_refine_20_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_restart_refine_20_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_EnzoBlock::p_restart_done_22_closure : public SDAG::Closure {
      

      p_restart_done_22_closure() {
        init();
      }
      p_restart_done_22_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_restart_done_22_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_restart_done_22_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_method_accretion_end_23_closure : public SDAG::Closure {
      

      p_method_accretion_end_23_closure() {
        init();
      }
      p_method_accretion_end_23_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_method_accretion_end_23_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_method_accretion_end_23_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_cg_matvec_24_closure : public SDAG::Closure {
      

      p_solver_cg_matvec_24_closure() {
        init();
      }
      p_solver_cg_matvec_24_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_cg_matvec_24_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_cg_matvec_24_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_EnzoBlock::p_solver_cg_loop_2_28_closure : public SDAG::Closure {
      

      p_solver_cg_loop_2_28_closure() {
        init();
      }
      p_solver_cg_loop_2_28_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_cg_loop_2_28_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_cg_loop_2_28_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_EnzoBlock::p_solver_bicgstab_loop_2_37_closure : public SDAG::Closure {
      

      p_solver_bicgstab_loop_2_37_closure() {
        init();
      }
      p_solver_bicgstab_loop_2_37_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_bicgstab_loop_2_37_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_bicgstab_loop_2_37_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_bicgstab_loop_3_38_closure : public SDAG::Closure {
      

      p_solver_bicgstab_loop_3_38_closure() {
        init();
      }
      p_solver_bicgstab_loop_3_38_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_bicgstab_loop_3_38_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_bicgstab_loop_3_38_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_bicgstab_loop_8_39_closure : public SDAG::Closure {
      

      p_solver_bicgstab_loop_8_39_closure() {
        init();
      }
      p_solver_bicgstab_loop_8_39_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_bicgstab_loop_8_39_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_bicgstab_loop_8_39_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_bicgstab_loop_9_40_closure : public SDAG::Closure {
      

      p_solver_bicgstab_loop_9_40_closure() {
        init();
      }
      p_solver_bicgstab_loop_9_40_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_bicgstab_loop_9_40_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_bicgstab_loop_9_40_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_dot_recv_parent_41_closure : public SDAG::Closure {
            int n;
            long double *dot;
            std::vector<int> isa;
            int i_function;
      ...
      p_dot_recv_parent_41_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_dot_recv_parent_41_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|iter;
      ...
      virtual ~p_dot_recv_parent_41_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_dot_recv_parent_41_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_dot_recv_children_42_closure : public SDAG::Closure {
            int n;
            long double *dot;
            std::vector<int> isa;
            int i_function;
      ...
      p_dot_recv_children_42_closure() {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
      }
      p_dot_recv_children_42_closure(CkMigrateMessage*) {
        init();
        _impl_marshall = 0;
        _impl_buf_in = 0;
        _impl_buf_size = 0;
  ...
  implP|i_function;
      ...
      virtual ~p_dot_recv_children_42_closure() {
        if (_impl_marshall) CmiFree(UsrToEnv(_impl_marshall));
      }
      PUPable_decl(SINGLE_ARG(p_dot_recv_children_42_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_EnzoBlock::p_solver_dd_solve_coarse_45_closure : public SDAG::Closure {
      

      p_solver_dd_solve_coarse_45_closure() {
        init();
      }
      p_solver_dd_solve_coarse_45_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_dd_solve_coarse_45_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_dd_solve_coarse_45_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_dd_solve_domain_46_closure : public SDAG::Closure {
      

      p_solver_dd_solve_domain_46_closure() {
        init();
      }
      p_solver_dd_solve_domain_46_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_dd_solve_domain_46_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_dd_solve_domain_46_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_dd_last_smooth_47_closure : public SDAG::Closure {
      

      p_solver_dd_last_smooth_47_closure() {
        init();
      }
      p_solver_dd_last_smooth_47_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_dd_last_smooth_47_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_dd_last_smooth_47_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_EnzoBlock::p_solver_jacobi_continue_50_closure : public SDAG::Closure {
      

      p_solver_jacobi_continue_50_closure() {
        init();
      }
      p_solver_jacobi_continue_50_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_jacobi_continue_50_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_jacobi_continue_50_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_mg0_restrict_51_closure : public SDAG::Closure {
      

      p_solver_mg0_restrict_51_closure() {
        init();
      }
      p_solver_mg0_restrict_51_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_mg0_restrict_51_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_mg0_restrict_51_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_mg0_solve_coarse_52_closure : public SDAG::Closure {
      

      p_solver_mg0_solve_coarse_52_closure() {
        init();
      }
      p_solver_mg0_solve_coarse_52_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_mg0_solve_coarse_52_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_mg0_solve_coarse_52_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_mg0_post_smooth_53_closure : public SDAG::Closure {
      

      p_solver_mg0_post_smooth_53_closure() {
        init();
      }
      p_solver_mg0_post_smooth_53_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_mg0_post_smooth_53_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_mg0_post_smooth_53_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_EnzoBlock::p_solver_mg0_last_smooth_54_closure : public SDAG::Closure {
      

      p_solver_mg0_last_smooth_54_closure() {
        init();
      }
      p_solver_mg0_last_smooth_54_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_solver_mg0_last_smooth_54_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_solver_mg0_last_smooth_54_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
  PUPable_def(EnzoInitialKelvinHelmholtz)
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
  PUPable_def(EnzoPhysicsGravity)
#endif /* CK_TEMPLATES_ONLY */
...
void p_refine_create_block(MsgRefine* impl_msg);
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_refine_create_block(MsgRefine* impl_msg);
 */
void CProxyElement_EnzoSimulation::p_refine_create_block(MsgRefine* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupPe(), ckGetGroupID());
  } else {
    CkSendMsgBranch(CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupPe(), ckGetGroupID(),0);
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoSimulation::p_set_io_writer(const CProxy_IoEnzoWriter &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetGroupPe(), ckGetGroupID());
  } else {
    CkSendMsgBranch(CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetGroupPe(), ckGetGroupID(),0);
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoSimulation::p_infer_set_array_count(int count, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetGroupPe(), ckGetGroupID());
  } else {
    CkSendMsgBranch(CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetGroupPe(), ckGetGroupID(),0);
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoSimulation::p_set_io_reader(const CProxy_IoEnzoReader &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetGroupPe(), ckGetGroupID());
  } else {
    CkSendMsgBranch(CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetGroupPe(), ckGetGroupID(),0);
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoSimulation::p_set_level_array(const CProxy_EnzoLevelArray &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetGroupPe(), ckGetGroupID());
  } else {
    CkSendMsgBranch(CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetGroupPe(), ckGetGroupID(),0);
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_refine_create_block(MsgRefine* impl_msg);
 */
void CProxy_EnzoSimulation::p_refine_create_block(MsgRefine* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupBroadcast(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID());
  } else CkBroadcastMsgBranch(CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID(),0);
}
void CProxy_EnzoSimulation::p_refine_create_block(MsgRefine* impl_msg, int npes, int *pes) {
  CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID(), npes, pes,0);
}
void CProxy_EnzoSimulation::p_refine_create_block(MsgRefine* impl_msg, CmiGroup &grp) {
  CkSendMsgBranchGroup(CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID(), grp,0);
}

// Entry point registration function
int CkIndex_EnzoSimulation::reg_p_refine_create_block_MsgRefine() {
  int epidx = CkRegisterEp("p_refine_create_block(MsgRefine* impl_msg)",
      reinterpret_cast<CkCallFnPtr>(_call_p_refine_create_block_MsgRefine), CMessage_MsgRefine::__idx, __idx, 0);
  CkRegisterMessagePupFn(epidx, (CkMessagePupFn)MsgRefine::ckDebugPup);
  return epidx;
}

void CkIndex_EnzoSimulation::_call_p_refine_create_block_MsgRefine(void* impl_msg, void* impl_obj_void)
{
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  impl_obj->p_refine_create_block((MsgRefine*)impl_msg);
}
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_method_balance_check_5_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_check_done_7_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoSimulation::p_set_io_writer(const CProxy_IoEnzoWriter &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupBroadcast(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetGroupID());
  } else CkBroadcastMsgBranch(CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetGroupID(),0);
}
void CProxy_EnzoSimulation::p_set_io_writer(const CProxy_IoEnzoWriter &proxy, int npes, int *pes, const CkEntryOptions *impl_e_opts) {
  ...
  CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetGroupID(), npes, pes,0);
}
void CProxy_EnzoSimulation::p_set_io_writer(const CProxy_IoEnzoWriter &proxy, CmiGroup &grp, const CkEntryOptions *impl_e_opts) {
  ...
  CkSendMsgBranchGroup(CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetGroupID(), grp,0);
}

// Entry point registration function
int CkIndex_EnzoSimulation::reg_p_set_io_writer_marshall8() {
  int epidx = CkRegisterEp("p_set_io_writer(const CProxy_IoEnzoWriter &proxy)",
      reinterpret_cast<CkCallFnPtr>(_call_p_set_io_writer_marshall8), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_set_io_writer_marshall8);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_set_io_writer_marshall8);

  return epidx;
}

void CkIndex_EnzoSimulation::_call_p_set_io_writer_marshall8(void* impl_msg, void* impl_obj_void)
{
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoSimulation::_callmarshall_p_set_io_writer_marshall8(char* impl_buf, void* impl_obj_void) {
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: const CProxy_IoEnzoWriter &proxy*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoSimulation::_marshallmessagepup_p_set_io_writer_marshall8(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const CProxy_IoEnzoWriter &proxy*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_set_io_writer_8_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoSimulation::p_infer_set_array_count(int count, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupBroadcast(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetGroupID());
  } else CkBroadcastMsgBranch(CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetGroupID(),0);
}
void CProxy_EnzoSimulation::p_infer_set_array_count(int count, int npes, int *pes, const CkEntryOptions *impl_e_opts) {
  ...
  CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetGroupID(), npes, pes,0);
}
void CProxy_EnzoSimulation::p_infer_set_array_count(int count, CmiGroup &grp, const CkEntryOptions *impl_e_opts) {
  ...
  CkSendMsgBranchGroup(CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetGroupID(), grp,0);
}

// Entry point registration function
int CkIndex_EnzoSimulation::reg_p_infer_set_array_count_marshall9() {
  int epidx = CkRegisterEp("p_infer_set_array_count(int count)",
      reinterpret_cast<CkCallFnPtr>(_call_p_infer_set_array_count_marshall9), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_infer_set_array_count_marshall9);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_infer_set_array_count_marshall9);

  return epidx;
}

void CkIndex_EnzoSimulation::_call_p_infer_set_array_count_marshall9(void* impl_msg, void* impl_obj_void)
{
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoSimulation::_callmarshall_p_infer_set_array_count_marshall9(char* impl_buf, void* impl_obj_void) {
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int count*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoSimulation::_marshallmessagepup_p_infer_set_array_count_marshall9(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int count*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_infer_set_array_count_9_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_infer_array_created_10_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_infer_done_11_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoSimulation::p_set_io_reader(const CProxy_IoEnzoReader &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupBroadcast(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetGroupID());
  } else CkBroadcastMsgBranch(CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetGroupID(),0);
}
void CProxy_EnzoSimulation::p_set_io_reader(const CProxy_IoEnzoReader &proxy, int npes, int *pes, const CkEntryOptions *impl_e_opts) {
  ...
  CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetGroupID(), npes, pes,0);
}
void CProxy_EnzoSimulation::p_set_io_reader(const CProxy_IoEnzoReader &proxy, CmiGroup &grp, const CkEntryOptions *impl_e_opts) {
  ...
  CkSendMsgBranchGroup(CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetGroupID(), grp,0);
}

// Entry point registration function
int CkIndex_EnzoSimulation::reg_p_set_io_reader_marshall12() {
  int epidx = CkRegisterEp("p_set_io_reader(const CProxy_IoEnzoReader &proxy)",
      reinterpret_cast<CkCallFnPtr>(_call_p_set_io_reader_marshall12), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_set_io_reader_marshall12);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_set_io_reader_marshall12);

  return epidx;
}

void CkIndex_EnzoSimulation::_call_p_set_io_reader_marshall12(void* impl_msg, void* impl_obj_void)
{
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoSimulation::_callmarshall_p_set_io_reader_marshall12(char* impl_buf, void* impl_obj_void) {
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: const CProxy_IoEnzoReader &proxy*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoSimulation::_marshallmessagepup_p_set_io_reader_marshall12(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const CProxy_IoEnzoReader &proxy*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_set_io_reader_12_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_io_reader_created_13_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_restart_next_level_14_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_restart_level_created_15_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoSimulation::p_set_level_array(const CProxy_EnzoLevelArray &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupBroadcast(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetGroupID());
  } else CkBroadcastMsgBranch(CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetGroupID(),0);
}
void CProxy_EnzoSimulation::p_set_level_array(const CProxy_EnzoLevelArray &proxy, int npes, int *pes, const CkEntryOptions *impl_e_opts) {
  ...
  CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetGroupID(), npes, pes,0);
}
void CProxy_EnzoSimulation::p_set_level_array(const CProxy_EnzoLevelArray &proxy, CmiGroup &grp, const CkEntryOptions *impl_e_opts) {
  ...
  CkSendMsgBranchGroup(CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetGroupID(), grp,0);
}

// Entry point registration function
int CkIndex_EnzoSimulation::reg_p_set_level_array_marshall16() {
  int epidx = CkRegisterEp("p_set_level_array(const CProxy_EnzoLevelArray &proxy)",
      reinterpret_cast<CkCallFnPtr>(_call_p_set_level_array_marshall16), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_set_level_array_marshall16);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_set_level_array_marshall16);

  return epidx;
}

void CkIndex_EnzoSimulation::_call_p_set_level_array_marshall16(void* impl_msg, void* impl_obj_void)
{
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoSimulation::_callmarshall_p_set_level_array_marshall16(char* impl_buf, void* impl_obj_void) {
  EnzoSimulation* impl_obj = static_cast<EnzoSimulation*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: const CProxy_EnzoLevelArray &proxy*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoSimulation::_marshallmessagepup_p_set_level_array_marshall16(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const CProxy_EnzoLevelArray &proxy*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoSimulation::p_set_level_array_16_closure))
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_refine_create_block(MsgRefine* impl_msg);
 */
void CProxySection_EnzoSimulation::p_refine_create_block(MsgRefine* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     ckDelegatedTo()->GroupSectionSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetNumSections(), ckGetSectionIDs());
  } else {
    void *impl_msg_tmp;
    for (int i=0; i<ckGetNumSections(); ++i) {
       impl_msg_tmp= (i<ckGetNumSections()-1) ? CkCopyMsg((void **) &impl_msg):impl_msg;
       CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_refine_create_block_MsgRefine(), impl_msg_tmp, ckGetGroupIDn(i), ckGetNumElements(i), ckGetElements(i),0);
    }
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxySection_EnzoSimulation::p_set_io_writer(const CProxy_IoEnzoWriter &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     ckDelegatedTo()->GroupSectionSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg, ckGetNumSections(), ckGetSectionIDs());
  } else {
    void *impl_msg_tmp;
    for (int i=0; i<ckGetNumSections(); ++i) {
       impl_msg_tmp= (i<ckGetNumSections()-1) ? CkCopyMsg((void **) &impl_msg):impl_msg;
       CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_set_io_writer_marshall8(), impl_msg_tmp, ckGetGroupIDn(i), ckGetNumElements(i), ckGetElements(i),0);
    }
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxySection_EnzoSimulation::p_infer_set_array_count(int count, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     ckDelegatedTo()->GroupSectionSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg, ckGetNumSections(), ckGetSectionIDs());
  } else {
    void *impl_msg_tmp;
    for (int i=0; i<ckGetNumSections(); ++i) {
       impl_msg_tmp= (i<ckGetNumSections()-1) ? CkCopyMsg((void **) &impl_msg):impl_msg;
       CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_infer_set_array_count_marshall9(), impl_msg_tmp, ckGetGroupIDn(i), ckGetNumElements(i), ckGetElements(i),0);
    }
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxySection_EnzoSimulation::p_set_io_reader(const CProxy_IoEnzoReader &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     ckDelegatedTo()->GroupSectionSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg, ckGetNumSections(), ckGetSectionIDs());
  } else {
    void *impl_msg_tmp;
    for (int i=0; i<ckGetNumSections(); ++i) {
       impl_msg_tmp= (i<ckGetNumSections()-1) ? CkCopyMsg((void **) &impl_msg):impl_msg;
       CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_set_io_reader_marshall12(), impl_msg_tmp, ckGetGroupIDn(i), ckGetNumElements(i), ckGetElements(i),0);
    }
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxySection_EnzoSimulation::p_set_level_array(const CProxy_EnzoLevelArray &proxy, const CkEntryOptions *impl_e_opts)
{
  ...
  if (ckIsDelegated()) {
     ckDelegatedTo()->GroupSectionSend(ckDelegatedPtr(),CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg, ckGetNumSections(), ckGetSectionIDs());
  } else {
    void *impl_msg_tmp;
    for (int i=0; i<ckGetNumSections(); ++i) {
       impl_msg_tmp= (i<ckGetNumSections()-1) ? CkCopyMsg((void **) &impl_msg):impl_msg;
       CkSendMsgBranchMulti(CkIndex_EnzoSimulation::idx_p_set_level_array_marshall16(), impl_msg_tmp, ckGetGroupIDn(i), ckGetNumElements(i), ckGetElements(i),0);
    }
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CkIndex_EnzoSimulation::__register(const char *s, size_t size) {
  ...
  // REG: void p_refine_create_block(MsgRefine* impl_msg);
  idx_p_refine_create_block_MsgRefine();
  ...
  idx_p_set_io_writer_marshall8();

  // REG: void p_infer_set_array_count(int count);
  idx_p_infer_set_array_count_marshall9();
  ...
  idx_p_set_io_reader_marshall12();
  ...
  idx_p_set_level_array_marshall16();
...
void p_check_done();
void p_restart_refine(const int *ic3, int io_reader, int ip);
...
void CProxyElement_EnzoBlock::p_method_infer_merge_masks(int n, const char *mask, const int *ic3, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_method_infer_merge_masks_marshall12(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoBlock::p_method_infer_count_arrays(int count, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_method_infer_count_arrays_marshall13(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoBlock::p_method_infer_request_data(const int *il3, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_method_infer_request_data_marshall14(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoBlock::p_method_infer_update(int n, const char *buffer, const int *il3, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_method_infer_update_marshall15(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoBlock::p_check_write_first(int num_files, const std::string &ordering, const std::string &name_dir, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_check_write_first_marshall17(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoBlock::p_check_write_next(int num_files, const std::string &ordering, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_check_write_next_marshall18(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_restart_refine(const int *ic3, int io_reader, int ip);
 */
void CProxyElement_EnzoBlock::p_restart_refine(const int *ic3, int io_reader, int ip, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const int *ic3, int io_reader, int ip
  int impl_off=0;
  int impl_arrstart=0;
  int impl_off_ic3, impl_cnt_ic3;
  impl_off_ic3=impl_off=CK_ALIGN(impl_off,sizeof(int));
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_restart_refine_marshall20(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoBlock::p_dot_recv_parent(int n, const long double *dot, const std::vector<int> &isa, int i_function, int iter, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_dot_recv_parent_marshall41(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_EnzoBlock::p_dot_recv_children(int n, const long double *dot, const std::vector<int> &isa, int i_function, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_EnzoBlock::idx_p_dot_recv_children_marshall42(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_feedback_starss_end_3_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_m1_closure_solve_transport_eqn_4_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_balance_migrate_8_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_balance_done_9_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_gravity_continue_10_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_gravity_end_11_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoBlock::p_method_infer_merge_masks(int n, const char *mask, const int *ic3, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_method_infer_merge_masks_marshall12(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_method_infer_merge_masks_marshall12() {
  int epidx = CkRegisterEp("p_method_infer_merge_masks(int n, const char *mask, const int *ic3)",
      reinterpret_cast<CkCallFnPtr>(_call_p_method_infer_merge_masks_marshall12), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_method_infer_merge_masks_marshall12);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_method_infer_merge_masks_marshall12);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_method_infer_merge_masks_marshall12(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoBlock::_callmarshall_p_method_infer_merge_masks_marshall12(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int n, const char *mask, const int *ic3*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_method_infer_merge_masks_marshall12(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int n, const char *mask, const int *ic3*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_infer_merge_masks_12_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoBlock::p_method_infer_count_arrays(int count, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_method_infer_count_arrays_marshall13(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_method_infer_count_arrays_marshall13() {
  int epidx = CkRegisterEp("p_method_infer_count_arrays(int count)",
      reinterpret_cast<CkCallFnPtr>(_call_p_method_infer_count_arrays_marshall13), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_method_infer_count_arrays_marshall13);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_method_infer_count_arrays_marshall13);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_method_infer_count_arrays_marshall13(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoBlock::_callmarshall_p_method_infer_count_arrays_marshall13(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int count*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_method_infer_count_arrays_marshall13(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int count*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_infer_count_arrays_13_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoBlock::p_method_infer_request_data(const int *il3, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_method_infer_request_data_marshall14(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_method_infer_request_data_marshall14() {
  int epidx = CkRegisterEp("p_method_infer_request_data(const int *il3)",
      reinterpret_cast<CkCallFnPtr>(_call_p_method_infer_request_data_marshall14), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_method_infer_request_data_marshall14);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_method_infer_request_data_marshall14);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_method_infer_request_data_marshall14(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoBlock::_callmarshall_p_method_infer_request_data_marshall14(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: const int *il3*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_method_infer_request_data_marshall14(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const int *il3*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_infer_request_data_14_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoBlock::p_method_infer_update(int n, const char *buffer, const int *il3, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_method_infer_update_marshall15(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_method_infer_update_marshall15() {
  int epidx = CkRegisterEp("p_method_infer_update(int n, const char *buffer, const int *il3)",
      reinterpret_cast<CkCallFnPtr>(_call_p_method_infer_update_marshall15), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_method_infer_update_marshall15);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_method_infer_update_marshall15);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_method_infer_update_marshall15(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoBlock::_callmarshall_p_method_infer_update_marshall15(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int n, const char *buffer, const int *il3*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_method_infer_update_marshall15(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int n, const char *buffer, const int *il3*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_infer_update_15_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_infer_exit_16_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoBlock::p_check_write_first(int num_files, const std::string &ordering, const std::string &name_dir, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_check_write_first_marshall17(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_check_write_first_marshall17() {
  int epidx = CkRegisterEp("p_check_write_first(int num_files, const std::string &ordering, const std::string &name_dir)",
      reinterpret_cast<CkCallFnPtr>(_call_p_check_write_first_marshall17), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_check_write_first_marshall17);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_check_write_first_marshall17);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_check_write_first_marshall17(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoBlock::_callmarshall_p_check_write_first_marshall17(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int num_files, const std::string &ordering, const std::string &name_dir*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_check_write_first_marshall17(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int num_files, const std::string &ordering, const std::string &name_dir*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_check_write_first_17_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoBlock::p_check_write_next(int num_files, const std::string &ordering, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_check_write_next_marshall18(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_check_write_next_marshall18() {
  int epidx = CkRegisterEp("p_check_write_next(int num_files, const std::string &ordering)",
      reinterpret_cast<CkCallFnPtr>(_call_p_check_write_next_marshall18), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_check_write_next_marshall18);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_check_write_next_marshall18);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_check_write_next_marshall18(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoBlock::_callmarshall_p_check_write_next_marshall18(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int num_files, const std::string &ordering*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_check_write_next_marshall18(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int num_files, const std::string &ordering*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_check_write_next_18_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_check_done_19_closure))
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_restart_refine(const int *ic3, int io_reader, int ip);
 */
void CProxy_EnzoBlock::p_restart_refine(const int *ic3, int io_reader, int ip, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const int *ic3, int io_reader, int ip
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_restart_refine_marshall20(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_restart_refine_marshall20() {
  int epidx = CkRegisterEp("p_restart_refine(const int *ic3, int io_reader, int ip)",
      reinterpret_cast<CkCallFnPtr>(_call_p_restart_refine_marshall20), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_restart_refine_marshall20);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_restart_refine_marshall20);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_restart_refine_marshall20(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const int *ic3, int io_reader, int ip*/
  PUP::fromMem implP(impl_buf);
  int impl_off_ic3, impl_cnt_ic3;
  implP|impl_off_ic3;
  implP|impl_cnt_ic3;
  ...
  /*Unmarshall arrays:*/
  int *ic3=(int *)(impl_buf+impl_off_ic3);
  impl_obj->p_restart_refine(ic3, std::move(io_reader.t), std::move(ip.t));
}
int CkIndex_EnzoBlock::_callmarshall_p_restart_refine_marshall20(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: const int *ic3, int io_reader, int ip*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_restart_refine_marshall20(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: const int *ic3, int io_reader, int ip*/
  ...
  implDestP|io_reader;
  if (implDestP.hasComments()) implDestP.comment("ip");
  implDestP|ip;
}
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_restart_refine_20_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_restart_done_22_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_method_accretion_end_23_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_cg_matvec_24_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_cg_loop_2_28_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_bicgstab_loop_2_37_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_bicgstab_loop_3_38_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_bicgstab_loop_8_39_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_bicgstab_loop_9_40_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoBlock::p_dot_recv_parent(int n, const long double *dot, const std::vector<int> &isa, int i_function, int iter, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_dot_recv_parent_marshall41(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_dot_recv_parent_marshall41() {
  int epidx = CkRegisterEp("p_dot_recv_parent(int n, const long double *dot, const std::vector<int> &isa, int i_function, int iter)",
      reinterpret_cast<CkCallFnPtr>(_call_p_dot_recv_parent_marshall41), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_dot_recv_parent_marshall41);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_dot_recv_parent_marshall41);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_dot_recv_parent_marshall41(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoBlock::_callmarshall_p_dot_recv_parent_marshall41(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int n, const long double *dot, const std::vector<int> &isa, int i_function, int iter*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_dot_recv_parent_marshall41(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int n, const long double *dot, const std::vector<int> &isa, int i_function, int iter*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_dot_recv_parent_41_closure))
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_EnzoBlock::p_dot_recv_children(int n, const long double *dot, const std::vector<int> &isa, int i_function, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_EnzoBlock::idx_p_dot_recv_children_marshall42(),0);
}

// Entry point registration function
int CkIndex_EnzoBlock::reg_p_dot_recv_children_marshall42() {
  int epidx = CkRegisterEp("p_dot_recv_children(int n, const long double *dot, const std::vector<int> &isa, int i_function)",
      reinterpret_cast<CkCallFnPtr>(_call_p_dot_recv_children_marshall42), CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_p_dot_recv_children_marshall42);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_p_dot_recv_children_marshall42);

  return epidx;
}

void CkIndex_EnzoBlock::_call_p_dot_recv_children_marshall42(void* impl_msg, void* impl_obj_void)
{
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_EnzoBlock::_callmarshall_p_dot_recv_children_marshall42(char* impl_buf, void* impl_obj_void) {
  EnzoBlock* impl_obj = static_cast<EnzoBlock*>(impl_obj_void);
  envelope *env = UsrToEnv(impl_buf);
  /*Unmarshall pup'd fields: int n, const long double *dot, const std::vector<int> &isa, int i_function*/
  PUP::fromMem implP(impl_buf);
...
void CkIndex_EnzoBlock::_marshallmessagepup_p_dot_recv_children_marshall42(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int n, const long double *dot, const std::vector<int> &isa, int i_function*/
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_dot_recv_children_42_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_dd_solve_coarse_45_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_dd_solve_domain_46_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_dd_last_smooth_47_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_jacobi_continue_50_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_mg0_restrict_51_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_mg0_solve_coarse_52_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_mg0_post_smooth_53_closure))
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_EnzoBlock::p_solver_mg0_last_smooth_54_closure))
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_restart_refine(const int *ic3, int io_reader, int ip);
 */
void CProxySection_EnzoBlock::p_restart_refine(const int *ic3, int io_reader, int ip, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const int *ic3, int io_reader, int ip
  int impl_off=0;
...
void CkIndex_EnzoBlock::__register(const char *s, size_t size) {
  ...
  idx_p_check_write_first_marshall17();

  // REG: void p_check_write_next(int num_files, const std::string &ordering);
  idx_p_check_write_next_marshall18();

  // REG: void p_check_done();
  idx_p_check_done_void();

  // REG: void p_restart_refine(const int *ic3, int io_reader, int ip);
  idx_p_restart_refine_marshall20();
...
IoEnzoWriter();
IoEnzoWriter(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts);
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: IoEnzoWriter(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts);
 */
void CProxyElement_IoEnzoWriter::insert(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts, int onPE, const CkEntryOptions *impl_e_opts)
{ 
   //Marshall: int num_files, const std::string &ordering, int monitor_iter, int include_ghosts
  int impl_off=0;
  { //Find the size of the PUP'd data
    PUP::sizer implP;
    implP|num_files;
...
/* DEFS: IoEnzoWriter(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts);
 */
CkArrayID CProxy_IoEnzoWriter::ckNew(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts, const CkArrayOptions &opts, const CkEntryOptions *impl_e_opts)
{
  //Marshall: int num_files, const std::string &ordering, int monitor_iter, int include_ghosts
  int impl_off=0;
  { //Find the size of the PUP'd data
...
void CProxy_IoEnzoWriter::ckNew(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts, const CkArrayOptions &opts, CkCallback _ck_array_creation_cb, const CkEntryOptions *impl_e_opts)
{
  //Marshall: int num_files, const std::string &ordering, int monitor_iter, int include_ghosts
  int impl_off=0;
  { //Find the size of the PUP'd data
...
CkArrayID CProxy_IoEnzoWriter::ckNew(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts, const int s1, const CkEntryOptions *impl_e_opts)
{
  //Marshall: int num_files, const std::string &ordering, int monitor_iter, int include_ghosts
  int impl_off=0;
  { //Find the size of the PUP'd data
...
void CProxy_IoEnzoWriter::ckNew(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts, const int s1, CkCallback _ck_array_creation_cb, const CkEntryOptions *impl_e_opts)
{
  //Marshall: int num_files, const std::string &ordering, int monitor_iter, int include_ghosts
  int impl_off=0;
  { //Find the size of the PUP'd data
...
int CkIndex_IoEnzoWriter::reg_IoEnzoWriter_marshall2() {
  int epidx = CkRegisterEp("IoEnzoWriter(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts)",
...
void CkIndex_IoEnzoWriter::_call_IoEnzoWriter_marshall2(void* impl_msg, void* impl_obj_void)
{
  ...
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int num_files, const std::string &ordering, int monitor_iter, int include_ghosts*/
  PUP::fromMem implP(impl_buf);
  PUP::detail::TemporaryObjectHolder<int> num_files;
  implP|num_files;
  PUP::detail::TemporaryObjectHolder<std::string> ordering;
  ...
  implP|monitor_iter;
  PUP::detail::TemporaryObjectHolder<int> include_ghosts;
  implP|include_ghosts;
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
  new (impl_obj_void) IoEnzoWriter(std::move(num_files.t), std::move(ordering.t), std::move(monitor_iter.t), std::move(include_ghosts.t));
}
...
void CkIndex_IoEnzoWriter::_marshallmessagepup_IoEnzoWriter_marshall2(PUP::er &implDestP,void *impl_msg) {
  ...
  if (implDestP.hasComments()) implDestP.comment("include_ghosts");
  implDestP|include_ghosts;
}
#endif /* CK_TEMPLATES_ONLY */
...
void CkIndex_IoEnzoWriter::__register(const char *s, size_t size) {
  ...
  // REG: IoEnzoWriter(int num_files, const std::string &ordering, int monitor_iter, int include_ghosts);
...
void _registerenzo(void)
{
  ...
  CkRegisterReadonly("g_enzo_config","EnzoConfig",sizeof(g_enzo_config),(void *) &g_enzo_config,__xlater_roPup_g_enzo_config);
      ...
      PUPable_reg(EnzoInitialKelvinHelmholtz);
      ...
      PUPable_reg(EnzoPhysicsGravity);

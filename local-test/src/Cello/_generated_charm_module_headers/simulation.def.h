...
/* ---------------- method closures -------------- */
  ...
  implP|impl_cnt_buffer;
    ...
    struct Closure_Simulation::p_initial_block_created_15_closure : public SDAG::Closure {
      

      p_initial_block_created_15_closure() {
        init();
      }
      p_initial_block_created_15_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~p_initial_block_created_15_closure() {
      }
      PUPable_decl(SINGLE_ARG(p_initial_block_created_15_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
...
void p_initial_block_created();
void p_initialize_state(MsgState* impl_msg);
 ...
 */
void CProxyElement_Simulation::p_refine_create_block(MsgRefine* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupSend(ckDelegatedPtr(),CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupPe(), ckGetGroupID());
  } else {
    CkSendMsgBranch(CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupPe(), ckGetGroupID(),0);
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_initial_block_created();
 */
void CProxyElement_Simulation::p_initial_block_created(const CkEntryOptions *impl_e_opts)
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupSend(ckDelegatedPtr(),CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetGroupPe(), ckGetGroupID());
  } else {
    CkSendMsgBranch(CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetGroupPe(), ckGetGroupID(),0);
  }
}
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_initialize_state(MsgState* impl_msg);
 */
void CProxyElement_Simulation::p_initialize_state(MsgState* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupSend(ckDelegatedPtr(),CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetGroupPe(), ckGetGroupID());
  } else {
    CkSendMsgBranch(CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetGroupPe(), ckGetGroupID(),0);
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_refine_create_block(MsgRefine* impl_msg);
 */
void CProxy_Simulation::p_refine_create_block(MsgRefine* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupBroadcast(ckDelegatedPtr(),CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID());
  } else CkBroadcastMsgBranch(CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID(),0);
}
void CProxy_Simulation::p_refine_create_block(MsgRefine* impl_msg, int npes, int *pes) {
  CkSendMsgBranchMulti(CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID(), npes, pes,0);
}
void CProxy_Simulation::p_refine_create_block(MsgRefine* impl_msg, CmiGroup &grp) {
  CkSendMsgBranchGroup(CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetGroupID(), grp,0);
}

// Entry point registration function
int CkIndex_Simulation::reg_p_refine_create_block_MsgRefine() {
...
void CkIndex_Simulation::_call_p_refine_create_block_MsgRefine(void* impl_msg, void* impl_obj_void)
{
  Simulation* impl_obj = static_cast<Simulation*>(impl_obj_void);
...
/* DEFS: void p_initial_block_created();
 */
void CProxy_Simulation::p_initial_block_created(const CkEntryOptions *impl_e_opts)
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupBroadcast(ckDelegatedPtr(),CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetGroupID());
  } else CkBroadcastMsgBranch(CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetGroupID(),0);
}
void CProxy_Simulation::p_initial_block_created(int npes, int *pes, const CkEntryOptions *impl_e_opts) {
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  CkSendMsgBranchMulti(CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetGroupID(), npes, pes,0);
}
void CProxy_Simulation::p_initial_block_created(CmiGroup &grp, const CkEntryOptions *impl_e_opts) {
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  CkSendMsgBranchGroup(CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetGroupID(), grp,0);
}

// Entry point registration function
int CkIndex_Simulation::reg_p_initial_block_created_void() {
  int epidx = CkRegisterEp("p_initial_block_created()",
      reinterpret_cast<CkCallFnPtr>(_call_p_initial_block_created_void), 0, __idx, 0);
  return epidx;
}

void CkIndex_Simulation::_call_p_initial_block_created_void(void* impl_msg, void* impl_obj_void)
{
  Simulation* impl_obj = static_cast<Simulation*>(impl_obj_void);
  impl_obj->p_initial_block_created();
  if(UsrToEnv(impl_msg)->isVarSysMsg() == 0)
    CkFreeSysMsg(impl_msg);
}
PUPable_def(SINGLE_ARG(Closure_Simulation::p_initial_block_created_15_closure))
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: void p_initialize_state(MsgState* impl_msg);
 */
void CProxy_Simulation::p_initialize_state(MsgState* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     CkGroupMsgPrep(CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetGroupID());
     ckDelegatedTo()->GroupBroadcast(ckDelegatedPtr(),CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetGroupID());
  } else CkBroadcastMsgBranch(CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetGroupID(),0);
}
void CProxy_Simulation::p_initialize_state(MsgState* impl_msg, int npes, int *pes) {
  CkSendMsgBranchMulti(CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetGroupID(), npes, pes,0);
}
void CProxy_Simulation::p_initialize_state(MsgState* impl_msg, CmiGroup &grp) {
  CkSendMsgBranchGroup(CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetGroupID(), grp,0);
}

// Entry point registration function
int CkIndex_Simulation::reg_p_initialize_state_MsgState() {
  int epidx = CkRegisterEp("p_initialize_state(MsgState* impl_msg)",
      reinterpret_cast<CkCallFnPtr>(_call_p_initialize_state_MsgState), CMessage_MsgState::__idx, __idx, 0);
  CkRegisterMessagePupFn(epidx, (CkMessagePupFn)MsgState::ckDebugPup);
  return epidx;
}

void CkIndex_Simulation::_call_p_initialize_state_MsgState(void* impl_msg, void* impl_obj_void)
{
  Simulation* impl_obj = static_cast<Simulation*>(impl_obj_void);
  impl_obj->p_initialize_state((MsgState*)impl_msg);
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_refine_create_block(MsgRefine* impl_msg);
 */
void CProxySection_Simulation::p_refine_create_block(MsgRefine* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     ckDelegatedTo()->GroupSectionSend(ckDelegatedPtr(),CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg, ckGetNumSections(), ckGetSectionIDs());
  } else {
    void *impl_msg_tmp;
    for (int i=0; i<ckGetNumSections(); ++i) {
       impl_msg_tmp= (i<ckGetNumSections()-1) ? CkCopyMsg((void **) &impl_msg):impl_msg;
       CkSendMsgBranchMulti(CkIndex_Simulation::idx_p_refine_create_block_MsgRefine(), impl_msg_tmp, ckGetGroupIDn(i), ckGetNumElements(i), ckGetElements(i),0);
    }
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_initial_block_created();
 */
void CProxySection_Simulation::p_initial_block_created(const CkEntryOptions *impl_e_opts)
{
  ckCheck();
  void *impl_msg = CkAllocSysMsg(impl_e_opts);
  if (ckIsDelegated()) {
     ckDelegatedTo()->GroupSectionSend(ckDelegatedPtr(),CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg, ckGetNumSections(), ckGetSectionIDs());
  } else {
    void *impl_msg_tmp;
    for (int i=0; i<ckGetNumSections(); ++i) {
       impl_msg_tmp= (i<ckGetNumSections()-1) ? CkCopyMsg((void **) &impl_msg):impl_msg;
       CkSendMsgBranchMulti(CkIndex_Simulation::idx_p_initial_block_created_void(), impl_msg_tmp, ckGetGroupIDn(i), ckGetNumElements(i), ckGetElements(i),0);
    }
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: void p_initialize_state(MsgState* impl_msg);
 */
void CProxySection_Simulation::p_initialize_state(MsgState* impl_msg)
{
  ckCheck();
  if (ckIsDelegated()) {
     ckDelegatedTo()->GroupSectionSend(ckDelegatedPtr(),CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg, ckGetNumSections(), ckGetSectionIDs());
  } else {
    void *impl_msg_tmp;
    for (int i=0; i<ckGetNumSections(); ++i) {
       impl_msg_tmp= (i<ckGetNumSections()-1) ? CkCopyMsg((void **) &impl_msg):impl_msg;
       CkSendMsgBranchMulti(CkIndex_Simulation::idx_p_initialize_state_MsgState(), impl_msg_tmp, ckGetGroupIDn(i), ckGetNumElements(i), ckGetElements(i),0);
    }
  }
}
#endif /* CK_TEMPLATES_ONLY */
...
void CkIndex_Simulation::__register(const char *s, size_t size) {
  ...
  // REG: void p_initial_block_created();
  idx_p_initial_block_created_void();

  // REG: void p_initialize_state(MsgState* impl_msg);
  idx_p_initialize_state_MsgState();
...
MappingArray(int impl_noname_0, int impl_noname_1, int impl_noname_2);
...
#endif /* CK_TEMPLATES_ONLY */
#ifndef CK_TEMPLATES_ONLY
/* DEFS: MappingArray(int impl_noname_0, int impl_noname_1, int impl_noname_2);
 */
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: MappingArray(int impl_noname_0, int impl_noname_1, int impl_noname_2);
 */
CkGroupID CProxy_MappingArray::ckNew(int impl_noname_0, int impl_noname_1, int impl_noname_2, const CkEntryOptions *impl_e_opts)
{
  ...
  CProxy_MappingArray::CProxy_MappingArray(int impl_noname_0, int impl_noname_1, int impl_noname_2, const CkEntryOptions *impl_e_opts)
{
  //Marshall: int impl_noname_0, int impl_noname_1, int impl_noname_2
  int impl_off=0;
  { //Find the size of the PUP'd data
...
int CkIndex_MappingArray::reg_MappingArray_marshall1() {
  int epidx = CkRegisterEp("MappingArray(int impl_noname_0, int impl_noname_1, int impl_noname_2)",
...
void CkIndex_MappingArray::_call_MappingArray_marshall1(void* impl_msg, void* impl_obj_void)
{
  ...
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
  new (impl_obj_void) MappingArray(std::move(impl_noname_0.t), std::move(impl_noname_1.t), std::move(impl_noname_2.t));
}
...
void CkIndex_MappingArray::__register(const char *s, size_t size) {
  ...
  // REG: MappingArray(int impl_noname_0, int impl_noname_1, int impl_noname_2);
...
MappingTree(int impl_noname_3, int impl_noname_4, int impl_noname_5);
...
#endif /* CK_TEMPLATES_ONLY */
#ifndef CK_TEMPLATES_ONLY
/* DEFS: MappingTree(int impl_noname_3, int impl_noname_4, int impl_noname_5);
 */
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: MappingTree(int impl_noname_3, int impl_noname_4, int impl_noname_5);
 */
CkGroupID CProxy_MappingTree::ckNew(int impl_noname_3, int impl_noname_4, int impl_noname_5, const CkEntryOptions *impl_e_opts)
{
  ...
  CProxy_MappingTree::CProxy_MappingTree(int impl_noname_3, int impl_noname_4, int impl_noname_5, const CkEntryOptions *impl_e_opts)
{
  //Marshall: int impl_noname_3, int impl_noname_4, int impl_noname_5
  int impl_off=0;
  { //Find the size of the PUP'd data
...
int CkIndex_MappingTree::reg_MappingTree_marshall1() {
  int epidx = CkRegisterEp("MappingTree(int impl_noname_3, int impl_noname_4, int impl_noname_5)",
...
void CkIndex_MappingTree::_call_MappingTree_marshall1(void* impl_msg, void* impl_obj_void)
{
  ...
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
  new (impl_obj_void) MappingTree(std::move(impl_noname_3.t), std::move(impl_noname_4.t), std::move(impl_noname_5.t));
}
...
void CkIndex_MappingTree::__register(const char *s, size_t size) {
  ...
  // REG: MappingTree(int impl_noname_3, int impl_noname_4, int impl_noname_5);
...
#endif /* CK_TEMPLATES_ONLY */
#ifndef CK_TEMPLATES_ONLY
/* DEFS: MappingIo(int impl_noname_6);
 */
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: MappingIo(int impl_noname_6);
 */
CkGroupID CProxy_MappingIo::ckNew(int impl_noname_6, const CkEntryOptions *impl_e_opts)
{
  //Marshall: int impl_noname_6
  int impl_off=0;
  { //Find the size of the PUP'd data
    PUP::sizer implP;
    implP|impl_noname_6;
  ...
  CProxy_MappingIo::CProxy_MappingIo(int impl_noname_6, const CkEntryOptions *impl_e_opts)
{
  //Marshall: int impl_noname_6
  int impl_off=0;
  { //Find the size of the PUP'd data
...
int CkIndex_MappingIo::reg_MappingIo_marshall1() {
  int epidx = CkRegisterEp("MappingIo(int impl_noname_6)",
...
void CkIndex_MappingIo::_call_MappingIo_marshall1(void* impl_msg, void* impl_obj_void)
{
  ...
  char *impl_buf=impl_msg_typed->msgBuf;
  envelope *env = UsrToEnv(impl_msg_typed);
  /*Unmarshall pup'd fields: int impl_noname_6*/
  PUP::fromMem implP(impl_buf);
  PUP::detail::TemporaryObjectHolder<int> impl_noname_6;
  implP|impl_noname_6;
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
  new (impl_obj_void) MappingIo(std::move(impl_noname_6.t));
}
...
void CkIndex_MappingIo::__register(const char *s, size_t size) {
  ...
  // REG: MappingIo(int impl_noname_6);

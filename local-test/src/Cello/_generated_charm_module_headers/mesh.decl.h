...
/* DECLS: readonly int MsgState::counter[CONFIG_NODE_SIZE];
 */
...
#endif
/* DECLS: message MsgState;
 */
class MsgState;
class CMessage_MsgState:public CkMessage{
  public:
    static int __idx;
    void* operator new(size_t, void*p) { return p; }
    void* operator new(size_t);
    ...
    static void dealloc(void *p);
    CMessage_MsgState();
    static void *pack(MsgState *p);
    static MsgState* unpack(void* p);
    void *operator new(size_t, const int);
    void *operator new(size_t, const int, const GroupDepNum);
#if CMK_MULTIPLE_DELETE
    void operator delete(void *p, const int){dealloc(p);}
...
class CkIndex_Block:public CkIndex_ArrayElement{
  public:
    ...
    /* DECLS: void p_initial_begin();
     */
    // Entry point registration at startup
    
    static int reg_p_initial_begin_void();
    // Entry point index lookup
    
    inline static int idx_p_initial_begin_void() {
      static int epidx = reg_p_initial_begin_void();
      return epidx;
    }

    
    inline static int idx_p_initial_begin(void (Block::*)() ) {
      return idx_p_initial_begin_void();
    }


    
    static int p_initial_begin() { return idx_p_initial_begin_void(); }
    
    static void _call_p_initial_begin_void(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_initial_begin_void(void* impl_msg, void* impl_obj);
    ...
    static int reg_p_output_write_marshall14();
    // Entry point index lookup
    
    inline static int idx_p_output_write_marshall14() {
      static int epidx = reg_p_output_write_marshall14();
      return epidx;
    }

    
    inline static int idx_p_output_write(void (Block::*)(int index_output, int step) ) {
      return idx_p_output_write_marshall14();
    }


    
    static int p_output_write(int index_output, int step) { return idx_p_output_write_marshall14(); }
    
    static void _call_p_output_write_marshall14(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_output_write_marshall14(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_p_output_write_marshall14(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_p_output_write_marshall14(PUP::er &p,void *msg);
    ...
    static int reg_p_method_order_morton_weight_marshall24();
    // Entry point index lookup
    
    inline static int idx_p_method_order_morton_weight_marshall24() {
      static int epidx = reg_p_method_order_morton_weight_marshall24();
      return epidx;
    }

    
    inline static int idx_p_method_order_morton_weight(void (Block::*)(const int *ic3, int weight, const Index &index) ) {
      return idx_p_method_order_morton_weight_marshall24();
    }


    
    static int p_method_order_morton_weight(const int *ic3, int weight, const Index &index) { return idx_p_method_order_morton_weight_marshall24(); }
    
    static void _call_p_method_order_morton_weight_marshall24(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_method_order_morton_weight_marshall24(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_p_method_order_morton_weight_marshall24(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_p_method_order_morton_weight_marshall24(PUP::er &p,void *msg);
    /* DECLS: void p_method_order_morton_index(int index, int count);
     */
    // Entry point registration at startup
    
    static int reg_p_method_order_morton_index_marshall25();
    // Entry point index lookup
    
    inline static int idx_p_method_order_morton_index_marshall25() {
      static int epidx = reg_p_method_order_morton_index_marshall25();
      return epidx;
    }

    
    inline static int idx_p_method_order_morton_index(void (Block::*)(int index, int count) ) {
      return idx_p_method_order_morton_index_marshall25();
    }


    
    static int p_method_order_morton_index(int index, int count) { return idx_p_method_order_morton_index_marshall25(); }
    
    static void _call_p_method_order_morton_index_marshall25(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_method_order_morton_index_marshall25(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_p_method_order_morton_index_marshall25(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_p_method_order_morton_index_marshall25(PUP::er &p,void *msg);
    /* DECLS: void r_method_order_hilbert_continue(CkReductionMsg* impl_msg);
     */
    // Entry point registration at startup
    
    static int reg_r_method_order_hilbert_continue_CkReductionMsg();
    // Entry point index lookup
    
    inline static int idx_r_method_order_hilbert_continue_CkReductionMsg() {
      static int epidx = reg_r_method_order_hilbert_continue_CkReductionMsg();
      return epidx;
    }

    
    inline static int idx_r_method_order_hilbert_continue(void (Block::*)(CkReductionMsg* impl_msg) ) {
      return idx_r_method_order_hilbert_continue_CkReductionMsg();
    }


    
    static int r_method_order_hilbert_continue(CkReductionMsg* impl_msg) { return idx_r_method_order_hilbert_continue_CkReductionMsg(); }
    
    static void _call_r_method_order_hilbert_continue_CkReductionMsg(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_r_method_order_hilbert_continue_CkReductionMsg(void* impl_msg, void* impl_obj);
    /* DECLS: void r_method_order_hilbert_complete(CkReductionMsg* impl_msg);
     */
    // Entry point registration at startup
    
    static int reg_r_method_order_hilbert_complete_CkReductionMsg();
    // Entry point index lookup
    
    inline static int idx_r_method_order_hilbert_complete_CkReductionMsg() {
      static int epidx = reg_r_method_order_hilbert_complete_CkReductionMsg();
      return epidx;
    }

    
    inline static int idx_r_method_order_hilbert_complete(void (Block::*)(CkReductionMsg* impl_msg) ) {
      return idx_r_method_order_hilbert_complete_CkReductionMsg();
    }


    
    static int r_method_order_hilbert_complete(CkReductionMsg* impl_msg) { return idx_r_method_order_hilbert_complete_CkReductionMsg(); }
    
    static void _call_r_method_order_hilbert_complete_CkReductionMsg(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_r_method_order_hilbert_complete_CkReductionMsg(void* impl_msg, void* impl_obj);
    /* DECLS: void p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index);
     */
    // Entry point registration at startup
    
    static int reg_p_method_order_hilbert_weight_marshall28();
    // Entry point index lookup
    
    inline static int idx_p_method_order_hilbert_weight_marshall28() {
      static int epidx = reg_p_method_order_hilbert_weight_marshall28();
      return epidx;
    }

    
    inline static int idx_p_method_order_hilbert_weight(void (Block::*)(const int *ic3, int weight, const Index &index) ) {
      return idx_p_method_order_hilbert_weight_marshall28();
    }


    
    static int p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index) { return idx_p_method_order_hilbert_weight_marshall28(); }
    
    static void _call_p_method_order_hilbert_weight_marshall28(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_method_order_hilbert_weight_marshall28(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_p_method_order_hilbert_weight_marshall28(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_p_method_order_hilbert_weight_marshall28(PUP::er &p,void *msg);
    /* DECLS: void p_method_order_hilbert_index(int index, int count);
     */
    // Entry point registration at startup
    
    static int reg_p_method_order_hilbert_index_marshall29();
    // Entry point index lookup
    
    inline static int idx_p_method_order_hilbert_index_marshall29() {
      static int epidx = reg_p_method_order_hilbert_index_marshall29();
      return epidx;
    }

    
    inline static int idx_p_method_order_hilbert_index(void (Block::*)(int index, int count) ) {
      return idx_p_method_order_hilbert_index_marshall29();
    }


    
    static int p_method_order_hilbert_index(int index, int count) { return idx_p_method_order_hilbert_index_marshall29(); }
    
    static void _call_p_method_order_hilbert_index_marshall29(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_method_order_hilbert_index_marshall29(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_p_method_order_hilbert_index_marshall29(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_p_method_order_hilbert_index_marshall29(PUP::er &p,void *msg);
    ...
    static int reg_p_control_sync_count_marshall44();
    // Entry point index lookup
    
    inline static int idx_p_control_sync_count_marshall44() {
      static int epidx = reg_p_control_sync_count_marshall44();
      return epidx;
    }

    
    inline static int idx_p_control_sync_count(void (Block::*)(int entry_point, int id, int count) ) {
      return idx_p_control_sync_count_marshall44();
    }


    
    static int p_control_sync_count(int entry_point, int id, int count) { return idx_p_control_sync_count_marshall44(); }
    
    static void _call_p_control_sync_count_marshall44(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_control_sync_count_marshall44(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_p_control_sync_count_marshall44(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_p_control_sync_count_marshall44(PUP::er &p,void *msg);
    ...
    static int reg_p_refresh_child_marshall57();
    // Entry point index lookup
    
    inline static int idx_p_refresh_child_marshall57() {
      static int epidx = reg_p_refresh_child_marshall57();
      return epidx;
    }

    
    inline static int idx_p_refresh_child(void (Block::*)(int n, const char *a, const int *ic3) ) {
      return idx_p_refresh_child_marshall57();
    }


    
    static int p_refresh_child(int n, const char *a, const int *ic3) { return idx_p_refresh_child_marshall57(); }
    
    static void _call_p_refresh_child_marshall57(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_p_refresh_child_marshall57(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_p_refresh_child_marshall57(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_p_refresh_child_marshall57(PUP::er &p,void *msg);
 ...
 */
    ...
    void p_initial_begin(const CkEntryOptions *impl_e_opts=NULL) ;
 ...
 */
    ...
    void p_method_order_hilbert_weight(const int *ic3, int weight, const Index &index, const CkEntryOptions *impl_e_opts=NULL) ;

/* DECLS: void p_method_order_hilbert_index(int index, int count);
 */
    
    void p_method_order_hilbert_index(int index, int count, const CkEntryOptions *impl_e_opts=NULL) ;
...
class Closure_Block {
  public:
    ...
    struct p_initial_begin_6_closure;




    struct p_output_enter_9_closure;



    struct p_output_end_11_closure;


    struct p_output_exit_12_closure;



    struct p_output_write_14_closure;


    struct p_compute_enter_15_closure;


    struct p_compute_continue_16_closure;



    struct p_compute_exit_18_closure;



    struct p_method_flux_correct_refresh_20_closure;





    struct p_method_order_morton_weight_24_closure;


    struct p_method_order_morton_index_25_closure;




    struct p_method_order_hilbert_weight_28_closure;


    struct p_method_order_hilbert_index_29_closure;
    ...
    struct p_stopping_enter_36_closure;



    struct p_stopping_load_balance_38_closure;



    struct p_stopping_exit_40_closure;



    struct p_exit_42_closure;



    struct p_control_sync_count_44_closure;


    struct p_adapt_enter_45_closure;



    struct p_adapt_end_47_closure;


    struct p_adapt_update_48_closure;



    struct p_adapt_called_50_closure;


    struct p_adapt_exit_51_closure;


    struct p_adapt_delete_52_closure;
    ...
    struct p_refresh_child_57_closure;
